...
namespace DsfEMR.Controllers
{
    ...
    public class ParametersController : CommonController
    {
        ...
        {
            DsfHTTPResponse<List<ParameterModel>> responseData = new DsfHTTPResponse<List<ParameterModel>>();
            try
            {
        ...
        public string Post()
        {
            DsfHTTPResponse<ParameterModel> responseData = new DsfHTTPResponse<ParameterModel>();
            try
            {
