...
namespace DsfEMR.Controllers
{
    public class RadiologyController : CommonController
    {
        ...
        private object RequisitionsList(string reqOrderStatus, string reportOrderStatus, string typeList, DateTime? fromDate, DateTime? toDate)
        {
            ...
            List<int> imgValidTypeList = DsfJSONConvert.DeserializeObject<List<int>>(typeList);
        ...
        private object PostReport(RbacUser currentUser)
        {
            ...
            ImagingReportModel imgReport = DsfJSONConvert.DeserializeObject<ImagingReportModel>(reportDetails);
        ...
        {
            ImagingReportModel imgReport = DsfJSONConvert.DeserializeObject<ImagingReportModel>(ipDataStr);
        ...
        private object CancelInpatientRadRequest(string ipDataStr, RbacUser currentUser)
        {
            using (var radDbContextTransaction = _radiologyDbContext.Database.BeginTransaction())
            {
                try
                {
                    BillingTransactionItemModel inpatientRadTest = DsfJSONConvert.DeserializeObject<BillingTransactionItemModel>(ipDataStr);
        ...
        {
            int requisitionId = DsfJSONConvert.DeserializeObject<int>(ipDataStr);
        ...
        {
            RadiologyScanDoneDetail scandetail = DsfJSONConvert.DeserializeObject<RadiologyScanDoneDetail>(ipDataStr);
        ...
        public string Post()
        {
            ...
            try
            {
                ...
                {
                    string str = this.ReadPostData();
                    ImagingReportModel imgReport = DsfJSONConvert.DeserializeObject<ImagingReportModel>(str);
                    imgReport.CreatedOn = System.DateTime.Now;
                    imgReport.CreatedBy = currentUser.EmployeeId;
                    dbContext.ImagingReports.Add(imgReport);
                    dbContext.SaveChanges();
            ...
            try
            {
                ...
                else if (reqType == "cancelInpatientRadRequest")
                {
                    ...
                    using (var radDbContextTransaction = dbContextUpdate.Database.BeginTransaction())
                    {
                        ...
                        {
                            string str = this.ReadPostData();
                            BillingTransactionItemModel inpatientRadTest = DsfJSONConvert.DeserializeObject<BillingTransactionItemModel>(str);
                ...
                {
                    string str = this.ReadPostData();
                    int requisitionId = DsfJSONConvert.DeserializeObject<int>(str);
                ...
                {
                    string str = this.ReadPostData();
                    RadiologyScanDoneDetail scandetail = DsfJSONConvert.DeserializeObject<RadiologyScanDoneDetail>(str);
        ...
        {
            DsfHTTPResponse<object> uploadResponse = FileUploader.Upload(files, localFolder);
        ...
        [HttpPost]
        [Route("PostReport")]
        public DsfHTTPResponse<object> PostReport(ImagingReportModel imgreport,
        ...
        private string PutRequisitionItemStatus(int requisitionId, string orderStatus)
        {
            try
            {
                ...
                if (reqItem != null)
                {
                    ...
                    _radiologyDbContext.SaveChanges();
                    return ENUM_Dsf_HTTP_ResponseStatus.OK;
                }
                else
