...
export class PatientHealthCardComponent implements OnInit {
  ...
  public printImage() {
    ...
    popupWinindow.document.write('<html><head><link rel="stylesheet" type="text/css" href="../../../themes/theme-default/DsfStyle.css" /><style>@media print { @page { size: 270mm 150mm; margin-bottom: -75mm; } }</style></head><body  onload="window.print()">' + printContents + '</body></html>');
  ...
  public printWholeFrontSide() {
    ...
    if (printAgain) {
      ...
      popupWinindow = window.open('', '_blank', 'width=1600,height=700,scrollbars=no,menubar=no,toolbar=no,location=no,status=no,titlebar=no');
      popupWinindow.document.open();
      popupWinindow.document.write(`<html><head><link rel="stylesheet" type="text/css" href="../../../themes/theme-default/DsfStyle.css" />`
