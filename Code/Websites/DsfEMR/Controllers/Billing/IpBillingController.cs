    ...
    public class IpBillingController : CommonController
    {
        ...
        public async Task<string> UpdateDiscounts()
        {
            ...
            try
            {
                ...
                IPBillingDiscount_DTO iPBillingDiscountModel = DsfJSONConvert.DeserializeObject<IPBillingDiscount_DTO>(ipData);
        ...
        public string PostBillTransactionAndDischarge()
        {
            ...
            try
            {
                ...
                BillingDbContext billingDbContext = new BillingDbContext(connString);
                DateTime currentDate = DateTime.Now;
                IpBillingTxnVM ipBillingTxnVM = DsfJSONConvert.DeserializeObject<IpBillingTxnVM>(ipDataString);
