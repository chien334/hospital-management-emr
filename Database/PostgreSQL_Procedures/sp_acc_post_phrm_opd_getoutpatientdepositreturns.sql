CREATE OR REPLACE FUNCTION sp_acc_post_phrm_opd_getoutpatientdepositreturns(
    ...
    */
    ...
    from (
    	select 
    		...
    		,'OPD Deposit Adjusted for ' || (cast(deposit.createdon as date))::varchar AS "Description"
