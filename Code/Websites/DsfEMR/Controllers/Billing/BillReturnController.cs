...
namespace DsfEMR.Controllers
{
    ...
    public class BillReturnController : CommonController
    {
        ...
        private object SaveCreditNote(string ipDataString, RbacUser currentUser)
        {
            ...
            BillInvoiceReturnModel billInvoiceRet = DsfJSONConvert.DeserializeObject<BillInvoiceReturnModel>(ipDataString);
        ...
        {
            BillInvoiceReturnModel billInvoiceRet = DsfJSONConvert.DeserializeObject<BillInvoiceReturnModel>(billInvReturnModelStr);
                ...
                using (var dbContextTransaction = _billingDbContext.Database.BeginTransaction())
                {
                    try
                    {
                        ...
                        if (!string.IsNullOrEmpty(billTransactionStr))
                        {
                            ...
                            BillingTransactionModel billingTXN = DsfJSONConvert.DeserializeObject<BillingTransactionModel>(billTransactionStr);
