...
namespace DsfEMR.Controllers.Pharmacy
{
    public class PharmacyPurchaseController : CommonController
    {
        ...
        {
            PHRMGoodsReceiptViewModel grViewModelData = DsfJSONConvert.DeserializeObject<PHRMGoodsReceiptViewModel>(ipDataString);
            RbacUser currentUser = HttpContext.Session.Get<RbacUser>(ENUM_SessionVariables.CurrentUser);
        ...
        {
            PHRMGoodsReceiptModel goodsReceipt = DsfJSONConvert.DeserializeObject<PHRMGoodsReceiptModel>(ipDataString);
            RbacUser currentUser = HttpContext.Session.Get<RbacUser>(ENUM_SessionVariables.CurrentUser);
        ...
        private object UpdatePurchaseOrder(PurchaseOrder_DTO purchaseOrderDTO)
        {
            RbacUser currentUser = HttpContext.Session.Get<RbacUser>(ENUM_SessionVariables.CurrentUser);
            var currentDate = DateTime.Now;
            PHRMPurchaseOrderModel purchaseOrderFromClient = DsfJSONConvert.DeserializeObject<PHRMPurchaseOrderModel>(DsfJSONConvert.SerializeObject(purchaseOrderDTO));
