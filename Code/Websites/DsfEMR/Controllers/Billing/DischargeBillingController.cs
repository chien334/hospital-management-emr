...
using DsfEMR.ServerModel.BillingModels.DischargeStatementModels;
...
namespace DsfEMR.Controllers.Billing
{
    public class DischargeBillingController : CommonController
    {
        ...
        public IActionResult PostBillAndPharmacyTransactionAndDischarge()
        {
            ...
            PendingBill pendingBills = DsfJSONConvert.DeserializeObject<PendingBill>(strBillingTransactionData);
