...
namespace DsfEMR.Controllers.Reporting
{
    public class GovernmentReportingController : Controller
    {
        ...
        public string GetLaboratoryServices(DateTime FromDate, DateTime ToDate)
        {
            ...
            //DsfHTTPResponse<LaboratoryServices> responseData = new DsfHTTPResponse<LaboratoryServices>();
            //try
            //{
        ...
        //[DsfViewFilter("reports-laboratoryservices-view")]
        ...
        public string GetInpatientOutcome(DateTime FromDate, DateTime ToDate)
        {
            ...
            DsfHTTPResponse<InpatientServiceReportModel> responseData = new DsfHTTPResponse<InpatientServiceReportModel>();
            try
            {
                GovernmentReportDbContext govreportingDbContext = new GovernmentReportDbContext(connString);
        ...
        public string GetInpatientMorbidityReportData(DateTime FromDate, DateTime ToDate)
        {
            ...
            DsfHTTPResponse<InpatientMorbidityReportModel> responseData = new DsfHTTPResponse<InpatientMorbidityReportModel>();
            try
            {
                GovernmentReportDbContext govreportingDbContext = new GovernmentReportDbContext(connString);
        ...
        public string GetHospitalMortalityReportData(DateTime FromDate, DateTime ToDate)
        {
            ...
            DsfHTTPResponse<HospitalMortalityReportModel> responseData = new DsfHTTPResponse<HospitalMortalityReportModel>();
            try
            {
