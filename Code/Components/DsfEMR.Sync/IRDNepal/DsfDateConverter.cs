...
namespace DsfEMR.Sync.IRDNepal.Utilities
{
    //class for convert English Date to Nepali Date and vice versa
    public class DsfDateConvertor
    {
        public DsfDateConvertor()
        {
        ...
        public static NepaliDateType GetTodaysNepDate()
        {
            try
            {
                ...
                NepaliDateType nepDateToday = DsfDateConvertor.ConvertEngToNepDate(engDateToday);
                return nepDateToday;
            }
            catch (Exception ex)
            {
