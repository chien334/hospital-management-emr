...
@Component({
  ...
  templateUrl: './dsf-confirmation-dialog.component.html',
  styleUrls: ['./dsf-confirmation-dialog.component.css']
})
export class DsfConfirmationDialogComponent implements OnInit {
  title: string;
  message: string;
