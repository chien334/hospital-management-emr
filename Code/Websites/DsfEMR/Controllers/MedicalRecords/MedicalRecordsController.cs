...
using DsfEMR.ServerModel.MedicalRecords;
...
namespace DsfEMR.Controllers
{
    public class MedicalRecordsController : CommonController
    {
        ...
        private object GetMRDetailsOfPatient(int medicalRecordId, int patientVisitId)
        {
            ...
            medicalRecordOfPatient.AllTestList = DsfJSONConvert.DeserializeObject<List<PatLabtestSummaryModel>>(medicalRecordOfPatient.AllTests);
            //medicalRecordOfPatient.ICDCodeList = DsfJSONConvert.DeserializeObject<List<ICD10CodeModel>>(medicalRecordOfPatient.ICDCode);
        ...
        {
            MedicalRecordModel medicalRecordOfPatient = DsfJSONConvert.DeserializeObject<MedicalRecordModel>(ipStr);
        ...
        public ActionResult AddBirthDetails()
        {
            ...
            try
            {
                ...
                // deserialization
                List<BabyBirthDetailsModel> babyBirthDetails = DsfJSONConvert.DeserializeObject<List<BabyBirthDetailsModel>>(strData);
        ...
        public ActionResult AddDeathDetails()
        {
            ...
            try
            {
                ...
                // deserialization
                DeathDetailsModel deathDetails = DsfJSONConvert.DeserializeObject<DeathDetailsModel>(strData);
        ...
        public ActionResult PostFinalDiagnosis()
        {
            ...
            try
            {
                ...
                // deserialization
                List<FinalDiagnosisModel> finalDiagnosis = DsfJSONConvert.DeserializeObject<List<FinalDiagnosisModel>>(strData);
        ...
        {
            DeathDetailsModel deathDetails = DsfJSONConvert.DeserializeObject<DeathDetailsModel>(ipStr);
        ...
        {
            DeathDetailsModel deathDetail = DsfJSONConvert.DeserializeObject<DeathDetailsModel>(ipStr);
        ...
        {
            BabyBirthDetailsModel birthDetail = DsfJSONConvert.DeserializeObject<BabyBirthDetailsModel>(ipStr);
        ...
        private object PostFinalDiagnosisForEmergencyPatient(string strData, RbacUser currentUser)
        {
            ...
            List<EmergencyFinalDiagnosisModel> finalErDiagnosis = DsfJSONConvert.DeserializeObject<List<EmergencyFinalDiagnosisModel>>(strData);
