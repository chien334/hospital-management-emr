...
namespace DsfEMR.Tests
{
    ...
    {
        private const string MsSqlConnString = "Server=localhost;Database=DsfEMR;User Id=SA;Password=EMR_password123!;TrustServerCertificate=True";
        private const string PgSqlConnString = "Host=192.168.80.130;Database=dsf_emr;Username=admin;Password=Admin@Postgres123;Port=30432";
