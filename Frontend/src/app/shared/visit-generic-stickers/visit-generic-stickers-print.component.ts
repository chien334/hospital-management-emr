...
export class VisitSticker_Generic_PrintComponent {
    ...
    PrintStickers() {
        ...
        popupWinindow.document.write('<html><head><link rel="stylesheet" type="text/css" href="../../themes/theme-default/DsfStyle.css" /></head><body style="margin:0px !important;" onload="window.print()">' + printContents + '</body></html>');
