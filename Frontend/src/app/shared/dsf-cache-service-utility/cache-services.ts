...
export enum MasterType {
  ...
  COA="coa",//mumbai-team-june2021-dsf-accounting-cache-change
  VoucherType="voucherType", //mumbai-team-june2021-dsf-accounting-cache-change
  VoucherHead="voucherHead",//mumbai-team-june2021-dsf-accounting-cache-change
  PrimaryGroup="primaryGroup",//mumbai-team-june2021-dsf-accounting-cache-change
  CodeDetails="codeDetails",//mumbai-team-june2021-dsf-accounting-cache-change
  AuditReportType="auditReportType",//mumbai-team-june2021-dsf-accounting-cache-change
  LedgerGroups="ledgerGroups",//mumbai-team-june2021-dsf-accounting-cache-change
  Ledgers="ledgers",//mumbai-team-june2021-dsf-accounting-cache-change
  LedgersAll="ledgersAll",//mumbai-team-june2021-dsf-accounting-cache-change
...
export class DsfCache {
  ...
  static async GetAccCacheData(type: MasterType, id) {
    ...
    if (DsfCache.Data[type] == null) {
      ...
      return await DsfCache.Data[type];
    }
  }
  ...
  //mumbai-team-june2021-dsf-accounting-cache-change
  static clearDsfCacheByType(type) {
    this.Data[type] = null;
  }
}
