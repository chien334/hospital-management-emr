...
export class ReportGridColumnSettings {
  ...
  public DoctorReferral = [
    ...
    //    width: 150,
    //    template:
    //    `<a dsf-grid-action="details" class="grid-action">
    //       Details`
    //}
  ];
  ...
  public PackageSalesReport = [
    ...
    { headerName: "ReferedBy", field: "RequestedBy", width: 150 },
    {
      ...
      field: "",
      width: 100,
      template: `<a dsf-grid-action="sticker" class="grid-action">
                  Sticker
                </a>`,
    },
  ];
  ...
  public BillCreditSettlementReportColumns = [
    ...
    { headerName: "Return Cash Discount", field: "CashDiscReturn", width: 100 },
    {
      ...
      template:
        `<a dsf-grid-action="credit-settlement-view" class="grid-action">
              View Details
            </a>`
    }
  ];
  ...
  public DischargedPatient = [
    ...
    //     width: 280,
    //     template:
    //         `<a dsf-grid-action="bill-summary" class="grid-action">
    //           Billing Summary
    //         </a>`
    // }
  ];
  ...
  public CancelledPOReport = [
    ...
    { headerName: "Cancel Remark", field: "CancelRemarks", width: 150 },
    {
      ...
      field: "",
      width: 100,
      template: `<a dsf-grid-action="viewPO" class="grid-action">
                  View
                </a>`,
    },
  ];
  ...
  public CancelledGRReport = [
    ...
    { headerName: "Cancel Remark", field: "CancelRemarks", width: 150 },
    {
      ...
      field: "",
      width: 100,
      template: `<a dsf-grid-action="viewGR" class="grid-action">
                  View
                </a>`,
    },
  ];
