...
namespace DsfEMR.Controllers.Emergency
{
    ...
    public class EmergencyController : CommonController
    {
        ...
        public IActionResult UploadPatientConsentForm()
        {
            ...
            try
            {
                ...
                UploadConsentForm patFileData = DsfJSONConvert.DeserializeObject<UploadConsentForm>(reportDetails);
        ...
        private object AddPatient(RbacUser currentUser, string ipStr)
        {
            using (var emergencyDbContextTransaction = _emergencyDbContext.Database.BeginTransaction())
            {
                try
                {
                    EmergencyPatientModel emergencyPatient = DsfJSONConvert.DeserializeObject<EmergencyPatientModel>(ipStr);
                    ...
                    if (ERParamStr != null)
                    {
                        erParam = DsfJSONConvert.DeserializeObject<ERParamClass>(ERParamStr);
                    }
        ...
        private object AddDischargeSummary(string ipStr, RbacUser currentUser)
        {
            using (var emergencyDbContextTransaction = _emergencyDbContext.Database.BeginTransaction())
            {
                try
                {
                    EmergencyDischargeSummaryModel ERDischargeSummary = DsfJSONConvert.DeserializeObject<EmergencyDischargeSummaryModel>(ipStr);
        ...
        {
            EmergencyDischargeSummaryModel ERDischargeSummary = DsfJSONConvert.DeserializeObject<EmergencyDischargeSummaryModel>(str);
        ...
        {
            EmergencyPatientModel emergencyPatient = DsfJSONConvert.DeserializeObject<EmergencyPatientModel>(str);
