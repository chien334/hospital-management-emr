CREATE OR REPLACE FUNCTION sp_acc_post_phrm_getpharmacystockmanageouttransactions(
    ...
    */
    ...
    from (
    	select 
    		...
    		,'PHARMACY STOCK MANAGE OUT FOR : ' || '(' || (cast(stocktxn.transactiondate as date))::varchar ||')'  AS "Description"
    		,0 AS "LedgerId"
    		,0 AS "SubLedgerId"
