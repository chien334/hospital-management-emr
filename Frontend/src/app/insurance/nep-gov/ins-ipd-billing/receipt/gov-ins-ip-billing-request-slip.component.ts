...
export class GovInsuranceIPBillingRequestSlipComponent {
  ...
  print() {
    ...
    popupWinindow.document.write('<html><head><link rel="stylesheet" type="text/css" href="../../themes/theme-default/DsfStyle.css" /><link rel="stylesheet" type="text/css" href="../../themes/theme-default/PrintStyle.css" /></head><body onload="window.print()">' + printContents + '</body></html>');
