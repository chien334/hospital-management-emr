...
namespace DsfEMR.Controllers
{
    ...
    public class EmployeeSettingsController : CommonController
    {
        ...
        //        //if (reqType == "post-employee")
        //        //{
        //        //    EmployeeModel emp = DsfJSONConvert.DeserializeObject<EmployeeModel>(str);
        ...
        //        //if (reqType == "post-employee-role")
        //        //{
        //        //    EmployeeRoleModel empRole = DsfJSONConvert.DeserializeObject<EmployeeRoleModel>(str);
        ...
        //        //if (reqType == "post-employee-type")
        //        //{
        //        //    EmployeeTypeModel empType = DsfJSONConvert.DeserializeObject<EmployeeTypeModel>(str);
        ...
        //        //if (reqType == "post-ext-referrer")
        //        //{
        //        //    ExternalReferrerVM extRefVm = DsfJSONConvert.DeserializeObject<ExternalReferrerVM>(str);
        ...
        //        //if (reqType == "put-employee")
        //        //{
        //        //    EmployeeModel clientEmployee = DsfJSONConvert.DeserializeObject<EmployeeModel>(str);
        ...
        //        //if (reqType == "put-employee-role")
        //        //{
        //        //    EmployeeRoleModel employeeRole = DsfJSONConvert.DeserializeObject<EmployeeRoleModel>(str);
        ...
        //        //if (reqType == "put-employee-type")
        //        //{
        //        //    EmployeeTypeModel employeeType = DsfJSONConvert.DeserializeObject<EmployeeTypeModel>(str);
        ...
        {
            EmployeeModel emp = DsfJSONConvert.DeserializeObject<EmployeeModel>(ipDataStr);
        ...
        {
            EmployeeRoleModel empRole = DsfJSONConvert.DeserializeObject<EmployeeRoleModel>(ipDataStr);
        ...
        {
            EmployeeTypeModel empType = DsfJSONConvert.DeserializeObject<EmployeeTypeModel>(ipDataStr);
        ...
        {
            ExternalReferrerVM extRefVm = DsfJSONConvert.DeserializeObject<ExternalReferrerVM>(ipDataStr);
            EmployeeModel emp = GetEmpModelFromExtReferrerModel(extRefVm);
        ...
        {
            EmployeeModel clientEmployee = DsfJSONConvert.DeserializeObject<EmployeeModel>(ipDataStr);
        ...
        {
            EmployeeRoleModel employeeRole = DsfJSONConvert.DeserializeObject<EmployeeRoleModel>(ipDataStr);
        ...
        {
            EmployeeTypeModel employeeType = DsfJSONConvert.DeserializeObject<EmployeeTypeModel>(ipDataStr);
