...
using DsfEMR.Controllers.Nursing.DTOs;
...
using DsfEMR.Services.Nursing.DTOs;
...
namespace DsfEMR.Controllers
{
    ...
    public class NursingController : CommonController
    {
        ...
        //if (reqType == "post-clinical-info")
        //{
        //    List<PatientClinicalInfo> patClinicalInfo = DsfJSONConvert.DeserializeObject<List<PatientClinicalInfo>>(str);
        ...
        //if (reqType == "put-clinical-info")
        //{
        //    List<PatientClinicalInfo> pat = DsfJSONConvert.DeserializeObject<List<PatientClinicalInfo>>(str);
        ...
        //if (reqType == "update-chief-complaint")
        //{
        //    PatientClinicalInfo patComp = DsfJSONConvert.DeserializeObject<PatientClinicalInfo>(str);
        ...
        private object AddToClinicalInfo(string ipDataStr, RbacUser currentUser)
        {
            ...
            List<PatientClinicalInfoModel> patClinicalInfo = DsfJSONConvert.DeserializeObject<List<PatientClinicalInfoModel>>(ipDataStr);
            int visitId = patClinicalInfo[0].PatientVisitId;
        ...
        private object UpdateComplaint(string ipDataStr, RbacUser currentUser)
        {
            ...
            PatientClinicalInfoModel patComp = DsfJSONConvert.DeserializeObject<PatientClinicalInfoModel>(ipDataStr);
        ...
        private object UpdateClinicalInfo(int patientId, int patientVisitId, string ipDataStr, RbacUser currentUser)
        {
            ...
            List<PatientClinicalInfoModel> pat = DsfJSONConvert.DeserializeObject<List<PatientClinicalInfoModel>>(ipDataStr);
            List<int> toBeUpdated = pat.Where(p => p.InfoId != 0).Select(x => x.InfoId).ToList();
