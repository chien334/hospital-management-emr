...
import { DsfConfirmationDialogComponent } from './dsf-confirmation-dialog.component';

@Directive({
  selector: '[DsfConfirmationDialog]'
})
export class DsfConfirmationDirective {
  ...
  private ConfirmationDialogComponentRef: ComponentRef<DsfConfirmationDialogComponent>;
  ...
  private showConfirmationDialog(): void {
    const factory = this.resolver.resolveComponentFactory(DsfConfirmationDialogComponent);
