...
using DsfEMR.ServerModel.LabModels;
using DsfEMR.Enums;
using DsfEMR.Core;
using System.Data;
...
namespace DsfEMR.Controllers
{
    ...
    public class LabController : CommonController
    {
        ...
        {
            //docPatPortalSync = _config.Value.DsfPatientPortalSync;           
            ...
            this.LabRunNumberSettings = (List<LabRunNumberSettingsModel>)DsfCache.GetMasterData(MasterDataEnum.LabRunNumberSettings);
        }
        ...
        public ActionResult PatientListForReportDispatch(string categoryIdList, DateTime FromDate, DateTime ToDate)
        {
            ...
            //{
            List<string> selCategoryList = DsfJSONConvert.DeserializeObject<List<string>>(categoryIdList);
       ...
       [HttpGet]
        ...
        public ActionResult RequisitionsByRequisitionIds(string requisitionIdList)
        {
            ...
            //{
            Func<object> func = () => {
                List<Int64> reqIdList = DsfJSONConvert.DeserializeObject<List<Int64>>(requisitionIdList);
        ...
        public ActionResult GenerateSampleCodeManual()
        {
            ...
            Func<object> func = () =>
            {
                ...
                RbacUser currentUser = HttpContext.Session.Get<RbacUser>("currentuser");
                var activeLabTypeName = HttpContext.Session.Get<string>(ENUM_SessionVariables.ActiveLabType);
                List<PatientLabSampleVM> labTests = DsfJSONConvert.DeserializeObject<List<PatientLabSampleVM>>(str); ;//this will come from client side--after parsing.
        ...
        public ActionResult UpdateLabReport()
        {
            ...
            Func<object> func = () =>
            {
                ...
                string specimenDataModel = this.ReadQueryStringData("specimenData");
                RbacUser currentUser = HttpContext.Session.Get<RbacUser>("currentuser");
                LabReportModel clientReport = DsfJSONConvert.DeserializeObject<LabReportModel>(str);
        ...
        public ActionResult UpdateVendorInLabRequisition()
        {
            ...
            Func<object> func = () =>
            {
                ...
                List<Int64> RequisitionIds = (DsfJSONConvert.DeserializeObject<List<Int64>>(str));
        ...
        public IActionResult UpdateExternalLabStatus([FromBody] ExternalLabStatusUpdate_DTO externalLabStatus)
        {
            Func<object> func = () =>
            {
                ...
                _labDbContext.SaveChanges();
                return Ok(ENUM_Dsf_HTTP_ResponseStatus.OK);
            };
             return InvokeHttpPutFunction<object>(func);
        }
        #endregion
        ...
        private int? GetInpatientLatestSampleSequence(LabDbContext labDbContext)
        {
            ...
            var latestYearSampleCode = (from smpl in samplesByType
                                        where DsfDateConvertor.ConvertEngToNepDate((DateTime)smpl.SampleDate).Year
                                            == DsfDateConvertor.ConvertEngToNepDate(System.DateTime.Now).Year
            ...
            LabRunNumberSettingsModel currentSetting, DateTime currentSampleDate)
        {
            ...
            var allReqFilteredByCurrYear = (from smpl in allReqOfCurrentType
                                            where DsfDateConvertor.ConvertEngToNepDate((DateTime)smpl.SampleCreatedOn).Year
                                                == DsfDateConvertor.ConvertEngToNepDate(currentSampleDate).Year
                                            select smpl).ToList();
            ...
            {
                var latestYearSampleCode = (from smpl in allReqFilteredByCurrYear
                                            where DsfDateConvertor.ConvertEngToNepDate((DateTime)smpl.SampleCreatedOn).Month
                                                == DsfDateConvertor.ConvertEngToNepDate(System.DateTime.Now).Month
                                            group smpl by 1 into req
                                            select new
                                            {
                                                SampleCode = req.Max(a => a.SampleCode)
            ...
            string visitType, string RunNumberType,string labType, bool isUnderInsurance = false)
        {
            ...
            //List<LabRunNumberSettingsModel> allLabRunNumberSettings = (List<LabRunNumberSettingsModel>)DsfCache.GetMasterData(MasterDataEnum.LabRunNumberSettings);
            ...
            if (currentRunNumSetting != null && sampleCode != null)
            {
                ...
                if (beforeSeparator == "num")
                {
                    if (afterSeparator.Contains("yy"))
                    {
                        ...
                        NepaliDateType nepDate = DsfDateConvertor.ConvertEngToNepDate(sampleCreatedOn);
            ...
            int PatientId = 0, DateTime? StartDate = null, DateTime? EndDate = null, List<int> categoryList = null, string labType = "")
        {
            ...
            var verificationObj = DsfJSONConvert.DeserializeObject<VerificationCoreCFGModel>(verificationParameter);
            ...
            int PatientId = 0, DateTime? StartDate = null, DateTime? EndDate = null, List<int> categoryList = null, string labType = "", bool isForLabMaster = false)
        {
            ...
            if (dataFromSP.Tables.Count > 0)
            {
                ...
                dSP = DsfJSONConvert.DeserializeObject<List<SPFlatReportVM>>(resultStr);
            }
        ...
        private LatestLabSampleCodeDetailVM GenerateLabSampleCode(LabDbContext labDbContext, string runNumType, string visitType, int patId, DateTime sampleDate, string labType, bool hasInsurance = false)
        {
            ...
            List<BarCodeNumber> barCode = DsfJSONConvert.DeserializeObject<List<BarCodeNumber>>(strData);
            ...
            List<SPLatestSampleCode> latestSampleModel = DsfJSONConvert.DeserializeObject<List<SPLatestSampleCode>>(strlatestSampleModel);
            ...
            if (dts.Tables.Count > 1)
            {
                ...
                ExistingBarCodeNumbers = DsfJSONConvert.DeserializeObject<List<SPExistingSampleCodeDetail>>(strAllReqOfCurrentType);
            }
            ...
            if (currentRunNumSetting != null)
            {
                ...
                if (beforeSeparator == "num")
                {
                    ...
                    {
                        var afterSeparatorLength = afterSeparator.Length;
                        NepaliDateType nepDate = DsfDateConvertor.ConvertEngToNepDate(sampleDate);
            ...
            using (TransactionScope trans = new TransactionScope())
            {
                try
                {
                    ...
                    if (dts.Tables.Count > 0)
                    {
                        ...
                        esistingReqOfPat = DsfJSONConvert.DeserializeObject<List<LabRequisitionModel>>(strPatExistingReq);
            ...
            foreach (var currVal in allRunNumSettingsByGroupingIndex)
            {
                if (currentSetting.ResetYearly || currentSetting.ResetMonthly || currentSetting.ResetDaily)
                {
                    ...
                    var repeatedSampleData = (from req in reqOfCurrentSampleYear
                                              where (currentSetting.ResetMonthly ? (DsfDateConvertor.ConvertEngToNepDate(req.SampleCreatedOn.Value).Month == DsfDateConvertor.ConvertEngToNepDate(sampleCreatedOn.Value).Month) : true)
        ...
        {
            List<int> selCategoryList = DsfJSONConvert.DeserializeObject<List<int>>(categoryIdList);
        ...
        private object CheckIsSampleCodeValid(DateTime SampleDate, int? SampleCode, string runNumberType, string visitType,string labType, bool? hasInsurance)
        {
            ...
            List<LabRunNumberSettingsModel> allLabRunNumSettings = (List<LabRunNumberSettingsModel>)DsfCache.GetMasterData(MasterDataEnum.LabRunNumberSettings);
            ...
            if (dts.Tables.Count > 0)
            {
                ...
                existingRequisition = DsfJSONConvert.DeserializeObject<List<LabRequisitionModel>>(strData);
            }
        ...
        private object GetLabDataByRunNumber(string formattedSampleCode)
        {
            ...
            NepaliDateType nepaliDate = DsfDateConvertor.ConvertEngToNepDate(englishDateToday);
            ...
            englishDateToday = DsfDateConvertor.ConvertNepToEngDate(nepaliDate);
        ...
        private object GetLabReportByRequisitionIds(string requisitionIdList)
        {
            ...
            {
                LabReportVM labReport = DsfEMR.Labs.LabsBL.GetLabReportVMForReqIds(_labDbContext, reqIdList, CovidReportUrlComonPath);
        ...
        private object GetLabReportByRequisitionIdsForReportDispatch(string requisitionIdList)
        {
            try
            {
                List<List<Int64>> reqIdList = DsfJSONConvert.DeserializeObject<List<List<Int64>>>(requisitionIdList);
                ...
                foreach (var reqList in reqIdList)
                {
                    if (reqList.Count > 0)
                    {
                        ...
                        if (allBarCode != null && allBarCode.Count == 1)
                        {
                            LabReportVM labReport = DsfEMR.Labs.LabsBL.GetLabReportVMForReqIds(_labDbContext, reqList, CovidReportUrlComonPath);
                            labReport.ValidToPrint = true;
                            labReport.BarCodeNumber = allBarCode[0];
        ...
        {
            // to store in cache
            List<LabTestModel> testsFromCache = (List<LabTestModel>)DsfCache.Get("lab-test-all");
            if (testsFromCache == null)
            {
                testsFromCache = _labDbContext.LabTests.ToList();
                DsfCache.Add("lab-test-all", testsFromCache, 5);
            }
        ...
        {
            List<LabTestSpecimenModel> labSpecimenList = DsfJSONConvert.DeserializeObject<List<LabTestSpecimenModel>>(specimenDataModel);
            List<LabTestComponentResult> labComponentFromClient = DsfJSONConvert.DeserializeObject<List<LabTestComponentResult>>(ipStr);
        ...
        //{
        //    List<LabRequisitionModel> labReqListFromClient = DsfJSONConvert.DeserializeObject<List<LabRequisitionModel>>(ipStr);
        ...
        private object LabReportAdd(RbacUser currentUser, string ipStr)
        {
            ...
            using (TransactionScope trans = new TransactionScope())
            {
                try
                {
                    LabReportModel labReport = DsfJSONConvert.DeserializeObject<LabReportModel>(ipStr);
        ...
        private object LabStickerSave(string ipStr, RbacUser currentUser,string PrinterName, int noOfPrints, string FolderPath)
        {
            ...
            if (ipStr.Length > 0)
            {
                ...
                ///api/Billing?reqType=saveLabSticker&PrinterName=sticker1809003399&FilePath=C:\DsfHealthInc_PvtLtd_Files\Print\
                //Read html
                ...
                if (parameter != null)
                {
                    paramArray = DsfJSONConvert.DeserializeObject<List<LabStickerParam>>(parameter);
                }
        ...
        {
            List<Int64> reqIdList = DsfJSONConvert.DeserializeObject<List<Int64>>(str);
            Int64? existingBarCodeNum = null;
        ...
        private object UpdateBillStatus(string str, string billstatus, RbacUser currentUser)
        {
            ...
            List<int> reqIds = DsfJSONConvert.DeserializeObject<List<int>>(str);
        ...
        {
            //string specimenDataModel = this.ReadQueryStringData("specimenData");
            List<LabTestComponentResult> labtestsresults = DsfJSONConvert.
        ...
        {
            List<Int64> requisitionIdList = DsfJSONConvert.DeserializeObject<List<Int64>>(labReqIdList);
        ...
        private object UpdateDoctor(string str, int prescriberId, RbacUser currentUser)
        {
            ...
            List<Int32> reqList = DsfJSONConvert.DeserializeObject<List<Int32>>(str);
        ...
        private object UpdateTestWithSamePrice(int reqId, string str)
        {
            using (var dbContextTransaction = _labDbContext.Database.BeginTransaction())
            {
                try
                {
                    ...
                    LabTestTransactionItemVM ChangedLabTest = DsfJSONConvert.DeserializeObject<LabTestTransactionItemVM>(str);
        ...
        private object CancelInpatientLabTest(string str, RbacUser currentUser)
        {
            using (var labDbContextTransaction = _labDbContext.Database.BeginTransaction())
            {
                try
                {
                    InpatientLabTestModel inpatientLabTest = DsfJSONConvert.DeserializeObject<InpatientLabTestModel>(str);
        ...
        {
            LabReportModel labReport = DsfJSONConvert.DeserializeObject<LabReportModel>(str);
            var VerificationEnabled = labReport.VerificationEnabled;
