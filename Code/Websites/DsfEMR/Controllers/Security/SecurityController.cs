...
namespace DsfEMR.Controllers
{
    ...
    public class SecurityController : CommonController
    {
        ...
        //        //    {
        //        //        List<DsfRoute> allRoutes = RBAC.GetAllRoutes();
        //        //        DsfRoute defRoute = allRoutes.Where(r => r.RouteId == defRouteId.Value).FirstOrDefault();
        //        //        if (defRoute != null)
        //        //        {
        ...
        //        //        List<DsfRoute> routeList = new List<DsfRoute>();
        ...
        //        //        HttpContext.Session.Set<List<DsfRoute>>("validRouteList", routeList);
        //        //    }
        //        //    else
        //        //    {
        ...
        //        //        responseData.Status = "OK";
        //        //        HttpContext.Session.Set<List<DsfRoute>>("validallrouteList", filteredRoutes);
        //        //    }
        //        //    else
        //        //    {
        //        //        responseData.Status = "Failed";
        ...
        //    }
        //    var routelist = DsfJSONConvert.SerializeObject(responseData, true);
        ...
        private void LocalizeRoutes(List<DsfRoute> routes, string lang)
        {
