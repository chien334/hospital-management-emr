...
using DsfEMR.ServerModel.AccountingModels.Transactions;
//using System.Collections;
...
namespace DsfEMR.Controllers
{
    ...
    public class AccountingController : CommonController
    {
        ...
        //    List<TransactionModel> result = DsfEMR.AccTransfer.AccountingTransferData.GetMapAndTransferDataSectionWise(1, SelectedDate, FiscalYearId, currentHospitalId);
        //    var unavailableLedger = DsfEMR.AccTransfer.AccountingTransferData.GetUnavailableLedgerList();
        ...
        //    }
        //    DsfEMR.AccTransfer.AccountingTransferData.ClearUnavailableLedgerList();
        //}
        //#endregion
        ...
        //    RbacUser currentUser = HttpContext.Session.Get<RbacUser>("currentuser");
        //    AccountingTransferData obj = new AccountingTransferData(connString, currentUser.EmployeeId, currentHospitalId);
        //   List<TransactionModel> res = DsfEMR.AccTransfer.AccountingTransferData.GetMapAndTransferDataSectionWise(2, SelectedDate, FiscalYearId, currentHospitalId);
        ...
        //    RbacUser currentUser = HttpContext.Session.Get<RbacUser>("currentuser");
        //    AccountingTransferData obj = new AccountingTransferData(connString, currentUser.EmployeeId, currentHospitalId);
        //    List<TransactionModel> result = DsfEMR.AccTransfer.AccountingTransferData.GetMapAndTransferDataSectionWise(3, SelectedDate, FiscalYearId, currentHospitalId);
        ...
        //    RbacUser currentUser = HttpContext.Session.Get<RbacUser>("currentuser");
        //    AccountingTransferData obj = new AccountingTransferData(connString, currentUser.EmployeeId, currentHospitalId);
        //    List<TransactionModel> result = DsfEMR.AccTransfer.AccountingTransferData.GetMapAndTransferDataSectionWise(5, SelectedDate, FiscalYearId, currentHospitalId);
        //    var unavailableLedger = DsfEMR.AccTransfer.AccountingTransferData.GetUnavailableLedgerList();
        //    if (unavailableLedger.Count > 0)
        //    {
        //        responseData.Status = "Failed";
        ...
        //else if (reqType == "code-details")
        //{
        //    var result = ((List<AccountingCodeDetailsModel>)DsfCache.GetMasterData(MasterDataEnum.AccountingCodes))
        ...
        //if (reqType == "postTransaction")
        //{
        //    TransactionModel txnClient = DsfJSONConvert.
        ...
        //                    });
        //                    string jsonTxnData = DsfJSONConvert.SerializeObject(txnList);
        //                    List<TransactionModel> txnsForJson = DsfJSONConvert.DeserializeObject<List<TransactionModel>>(jsonTxnData);
        //                    reverseTransactionData.TUId = txnsForJson[0].TUId;
        //                    reverseTransactionData.FiscalYearId = txnsForJson[0].FiscalyearId;
        //                    reverseTransactionData.JsonData = DsfJSONConvert.SerializeObject(txnsForJson);
        ...
        //    List<TransactionModel> txnListClient = DsfJSONConvert.
        ...
        //    List<TransactionModel> transactions = DsfJSONConvert.
        //        DeserializeObject<List<TransactionModel>>(str);
        ...
        //    FiscalYearModel fiscalYear = DsfJSONConvert.DeserializeObject<FiscalYearModel>(str);
        //    var CurrentDate = DateTime.Now.Date;
        ...
        //        try
        //        {
        //            List<LedgerModel> ledgers = DsfJSONConvert.DeserializeObject<List<LedgerModel>>(str);
        //            {
        //                ledgers.ForEach(led =>
        //                {
        ...
        //    {
        //        //RbacUser currentUser = HttpContext.Session.Get<RbacUser>("currentuser");//getting current user
        //        ReverseTransactionModel reverseTransactionData = DsfJSONConvert.DeserializeObject<ReverseTransactionModel>(str);
        //        reverseTransactionData.CreatedOn = DateTime.Now;
        //        reverseTransactionData.CreatedBy = currentUser.EmployeeId;
        ...
        //if (reqType == "postIncentivePaymentVoucher")
        //{
        //    PaymentInfoModel paymentInfoModel = DsfJSONConvert.DeserializeObject<PaymentInfoModel>(str);
        ...
        //    string transactionObject = this.ReadQueryStringData("transactionObj");
        //    TransactionModel txnClient = DsfJSONConvert.DeserializeObject<TransactionModel>(transactionObject);
        //    int payInfoId = 0;
        ...
        //    AccountingPaymentModel payment = DsfJSONConvert.DeserializeObject<AccountingPaymentModel>(str);
        //    string transactionObject = this.ReadQueryStringData("transactionObj");
        //    TransactionModel txnClient = DsfJSONConvert.DeserializeObject<TransactionModel>(transactionObject);
        //    int payInfoId = 0;
        //    using (var dbTransact = accountingDBContext.Database.BeginTransaction())
        ...
        //            string Str = this.ReadPostData();
        //            TransactionModel txnFromClient = DsfJSONConvert.DeserializeObject<TransactionModel>(Str);
        ...
        //            string jsonTxnData = DsfJSONConvert.SerializeObject(txnitemdata);
        //            List<TransactionItemModel> txnsForJson = DsfJSONConvert.DeserializeObject<List<TransactionItemModel>>(jsonTxnData);
        ...
        //            editvoucherLog.OldVocherJsonData = DsfJSONConvert.SerializeObject(txnsForJson);
        ...
        private string GetNepaliDate(DateTime mydate)
        {
            ...
            {
                string ndate = null;
                NepaliDateType nepDateToday = DsfDateConvertor.ConvertEngToNepDate(mydate);
        ...
        private object PostTransaction(string postStringContent, int currentHospitalId, RbacUser currentUser)
        {
            using (var accountingTransaction = _accountingDbContext.Database.BeginTransaction())
            {
                try
                {
                    TransactionModel txnClient = DsfJSONConvert.DeserializeObject<TransactionModel>(postStringContent);
                    if (txnClient != null)
                    {
