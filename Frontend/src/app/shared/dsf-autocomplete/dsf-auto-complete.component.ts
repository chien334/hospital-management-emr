 ...
 */
@Component({
    selector: "dsf-auto-complete",
    template: `
  <div class="dsf-auto-complete">
  ...
  .dsf-auto-complete > ul.empty {
    display: none;
  }

  .dsf-auto-complete > ul li {
    padding: 2px 5px;
    border-bottom: 1px solid #eee;
  }

  .dsf-auto-complete > ul li.selected {
    background-color: #ccc;
  }

  .dsf-auto-complete > ul li:last-child {
    border-bottom: none;
  }

  .dsf-auto-complete > ul li:hover {
    background-color: #ccc;
  }`
    ],
    encapsulation: ViewEncapsulation.None
})
export class DsfAutoCompleteComponent implements OnInit {
    ...
    constructor(
        ...
        public autoComplete: DsfAutoComplete
    ) {
    ...
    inputElKeyHandler = (evt: any) => {
        ...
        switch (evt.keyCode) {
            ...
            case 38: // UP, select the previous li el
                ...
                let ulElement1 = document.querySelector(".dsf-auto-complete ul");
                if (ulElement1) {
            ...
            case 40: // DOWN, select the next li el or the first one
                ...
                let ulElement2 = document.querySelector(".dsf-auto-complete ul");
                if (ulElement2) {
