...
using DsfEMR.Sync.IRDNepal.Utilities;

namespace DsfEMR.Sync.IRDNepal.Models
{
    ...
    //            credit_note_date = DsfDateConvertor.NepDateToString(DsfDateConvertor.ConvertEngToNepDate(Convert.ToDateTime(billReturn.CreatedOn.ToString()))),
    ...
    public class IRD_BillViewModel
    {
        ...
        public static IRD_BillViewModel GetMappedSalesBillForIRD(BillingTransactionModel billTxn, bool isRealTime)
        {
            ...
            IRD_BillViewModel salesBill = new IRD_BillViewModel()
            {
                ...
                invoice_date = DsfDateConvertor.NepDateToString(DsfDateConvertor.ConvertEngToNepDate(Convert.ToDateTime(billTxn.CreatedOn.ToString()))),
