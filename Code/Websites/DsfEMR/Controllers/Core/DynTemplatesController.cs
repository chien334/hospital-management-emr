...
using DsfEMR.Core.DynTemplates;
    ...
    public class DynTemplatesController : CommonController
    {
        ...
        public string Post()
        {
            ...
            try
            {
                ...
                {
                    Questionnaire qnrVM = DsfJSONConvert.
        ...
        public string Put()
        {
            ...
            try
            {
                ...
                if (reqType == "updateQnairs")
                {
                    ...
                    List<Questionnaire> qnrListFromclient = DsfJSONConvert.
        ...
        private void ConfigureTemplate(Template template, string renderMode = "fill")
        {
            ...
            string str = DsfJSONConvert.SerializeObject(template);
