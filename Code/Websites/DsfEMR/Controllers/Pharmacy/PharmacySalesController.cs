...
using DsfEMR.Services.Dispensary.DTOs;
using DsfEMR.Services.Dispensary.DTOs.PharmacyInvoiceReceipt;
using DsfEMR.Services.Dispensary.DTOs.PharmacyProvisional;
using DsfEMR.ServerModel.PharmacyModels.Provisional;
using DsfEMR.Services.Pharmacy.DTOs.Provisional;
using System.Data.Common;
using DsfEMR.ServerModel.SSFModels;
using DsfEMR.Services.Dispensary.DTOs.PharmacyConsumption;
...
namespace DsfEMR.Controllers.Pharmacy
{
    ...
    public class PharmacySalesController : CommonController
    {
        ...
        public IActionResult PostProvisionalInvoice([FromBody] List<PharmacyProvisionalSaleItem_DTO> provisionalItem)
        {
            ...
            List<PharmacyProvisionalSaleItem_DTO> t = DsfJSONConvert.DeserializeObject<List<PharmacyProvisionalSaleItem_DTO>>(s);
            List<PHRMInvoiceTransactionItemsModel> invoiceItems = DsfJSONConvert.DeserializeObject<List<PHRMInvoiceTransactionItemsModel>>(DsfJSONConvert.SerializeObject(provisionalItem));
            RbacUser currentUser = HttpContext.Session.Get<RbacUser>(ENUM_SessionVariables.CurrentUser);
        ...
        private void SaveProvisionalReturnItemsAfterCancel(List<PHRMTransactionProvisionalReturnItem_DTO> provisionalReturnItemsDTO, out List<PHRMTransactionProvisionalReturnItemsModel> provisionalReturnItems, RbacUser currentUser, DateTime currentDate, PharmacyFiscalYear currFiscalYear)
        {
            ...
            provisionalReturnItemsDTO.ForEach(item =>
            {
                ...
                provisionalReturnItem = DsfJSONConvert.DeserializeObject<PHRMTransactionProvisionalReturnItemsModel>(DsfJSONConvert.SerializeObject(item));
        ...
        {
            List<PHRMDrugsRequistionItemsModel> requisitionItems = DsfJSONConvert.DeserializeObject<List<PHRMDrugsRequistionItemsModel>>(ipDataStr);
        ...
        private object SaveOutdoorPatient(string ipDataString)
        {
            ...
            PHRMPatient patientData = DsfJSONConvert.DeserializeObject<PHRMPatient>(ipDataString);
        ...
        {
            PHRMInvoiceTransactionModel invoice = DsfJSONConvert.DeserializeObject<PHRMInvoiceTransactionModel>(DsfJSONConvert.SerializeObject(provisional));
        ...
        {
            PHRMDepositModel deposit = DsfJSONConvert.DeserializeObject<PHRMDepositModel>(ipDataString);
        ...
        private object UpdateProvisionalItemsCancel(string ipDataString, RbacUser currentUser)
        {
            ...
            List<PHRMInvoiceTransactionItemsModel> invoiceObjFromClient = DsfJSONConvert.DeserializeObject<List<PHRMInvoiceTransactionItemsModel>>(ipDataString);
        ...
        private object UpdateDepositPrintCount(string ipDataString)
        {
            ...
            PHRMDepositModel depositModel = DsfJSONConvert.DeserializeObject<PHRMDepositModel>(ipDataString);
