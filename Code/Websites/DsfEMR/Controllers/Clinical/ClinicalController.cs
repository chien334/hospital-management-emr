...
using DsfEMR.ServerModel.SSFModels.ClaimResponse;
using DocumentFormat.OpenXml.ExtendedProperties;
using DsfEMR.Enums;
using EntityState = Microsoft.EntityFrameworkCore.EntityState;
using OfficeOpenXml.FormulaParsing.Excel.Functions.Text;
using DsfEMR.ViewModel.Clinical;
using Microsoft.AspNetCore.Http;
using Syncfusion.XlsIO;
using DsfEMR.ServerModel.ClinicalModels.BloodSugarMonitoring;
using DsfEMR.ServerModel.ClinicalModels.Diet;
using DsfEMR.ServerModel.ClinicalModels.ConsulationRequests;
using DsfEMR.ServerModel.ClinicalModels.DTOs;
/* using DbFunctions = System.Data.Entity.DbFunctions; */
// For more information on enabling Web API for empty projects, visit http://go.microsoft.com/fwlink/?LinkID=397860

namespace DsfEMR.Controllers.Clinical
{
    ...
    public class ClinicalController : CommonController
    {
        ...
        private object UploadScannedImage(IFormFileCollection files, RbacUser currentUser)
        {
            ...
            PatientImagesModel patFileData = DsfJSONConvert.DeserializeObject<PatientImagesModel>(reportDetails);
        ...
        private object AddFreetextNoteTemplate(string str, RbacUser currentUser)
        {
            ...
            using (var dbContextTransaction = _clinicalDbContext.Database.BeginTransaction())
            {
                try
                {
                    ...
                    dbContextTransaction.Commit();
                    return ENUM_DsfHttpResponseText.OK;
                }
                catch (Exception ex)
                {
                    dbContextTransaction.Rollback();
        ...
        private object SaveScannedEyeImages(IFormFileCollection files, RbacUser currentUser)
        {
            ...
            EyeScanModel patFileData = DsfJSONConvert.DeserializeObject<EyeScanModel>(reportDetails);
            ////We Do Process in Transaction because Now Situation that 
