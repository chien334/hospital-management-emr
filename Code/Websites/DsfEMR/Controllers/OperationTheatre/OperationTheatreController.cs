...
namespace DsfEMR.Controllers
{
    public class OperationTheatreController : CommonController
    {
        ...
        {
                OtBookingListModel OTdetails = DsfJSONConvert.DeserializeObject<OtBookingListModel>(str);
        ...
        //        {
        //            OtBookingListModel otDetails = DsfJSONConvert.DeserializeObject<OtBookingListModel>(str);
        //            //OTTeamsModel teamInfo = DsfJSONConvert.DeserializeObject<OTTeamsModel>(str);
        ...
        //        {
        //            OtBookingListModel OTdetails = DsfJSONConvert.
