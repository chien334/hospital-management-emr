export default class CSSDGridColumns {
    ...
    static PendingItemColumns = [
        ...
        { headerName: "Action", field: "", template: `<a dsf-grid-action="disinfect-item" class="grid-action">Disinfect</a>` }
    ];
    ...
    static FinalizedItemColumns = [
        ...
        { headerName: "Action", field: "", template: `<a dsf-grid-action="dispatch-item" class="grid-action">Dispatch</a>` }
    ];
