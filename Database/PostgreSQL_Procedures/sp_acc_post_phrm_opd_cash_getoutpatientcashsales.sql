CREATE OR REPLACE FUNCTION sp_acc_post_phrm_opd_cash_getoutpatientcashsales(
...
BEGIN
    /*
     exec sp_acc_post_phrm_opd_cash_getoutpatientcashsales '2023-06-18',1
    
     change history
    sn.                auther/timestamp                   description
    1.                 devn/18th june 23                initial draft of sp to get opd (cash) pharmacy sales.
    */
    ...
    from (
    	select 
    		...
    		,'PHRM_OPD_CASH_Sales' AS "TransactionType"
