    ...
    public class AssetDepreciationDiscardingController : CommonController
    {
        ...
        public IActionResult PostAssetDepreciationDetails()
        {
            ...
            try
            {
                ...
                FixedAssetDepreciationModel deprnDetails = DsfJSONConvert.DeserializeObject<FixedAssetDepreciationModel>(Str);
        ...
        public IActionResult UpdateAssetScrapDetails()
        {
            ...
            {
                var Str = this.ReadPostData();
                FixedAssetStockModel details = DsfJSONConvert.DeserializeObject<FixedAssetStockModel>(Str);
