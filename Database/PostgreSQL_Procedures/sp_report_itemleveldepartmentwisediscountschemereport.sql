CREATE OR REPLACE FUNCTION sp_report_itemleveldepartmentwisediscountschemereport(
...
BEGIN
    ...
    */
    ...
    coalesce(retitm.rettotalamount,0) AS "NetRefundAmount",
    coalesce(retitm.retdiscountamount,0) AS "DiscountRefund",
    ...
    where ( 
    	...
    	and ((membershiptypeid = p_membershiptypeid or p_membershiptypeid is null) and (servicedepartmentid = p_servicedepartmentid or p_servicedepartmentid is null) and (billingtransactionid = p_billingtransactionid or p_billingtransactionid is null));
END;
$$ LANGUAGE plpgsql;