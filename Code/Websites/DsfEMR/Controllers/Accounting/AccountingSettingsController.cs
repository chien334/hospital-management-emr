...
using DsfEMR.ServerModel.AccountingModels.DTOs;
...
namespace DsfEMR.Controllers
{
    ...
    public class AccountingSettingsController : CommonController
    {
        ...
        [HttpGet]
        [Route("GetSubLedgers")]
        public async Task<DsfHTTPResponse<object>> GetSubLedgers()
        {
            DsfHTTPResponse<object> responseDate = new DsfHTTPResponse<object>();
            try
            {
                ...
                responseDate.Status = ENUM_DsfHttpResponseText.OK;
            }
            catch (Exception ex)
            {
                responseDate.Status = ENUM_DsfHttpResponseText.Failed;
        ...
        public async Task<DsfHTTPResponse<object>> ActivateDeactiveSubLedger([FromBody] SubLedgerModel subLedger)
        {
            AccountingDbContext accountingDbContext = new AccountingDbContext(connString);
        ...
        public async Task<DsfHTTPResponse<object>> UpdateSubLedger([FromBody] SubLedgerModel subLedger)
        {
            AccountingDbContext accountingDbContext = new AccountingDbContext(connString);
            using (var dbContextTransaction = accountingDbContext.Database.BeginTransaction())
            {
        ...
        [HttpPost]
        [Route("AddSubLedger")]
        public Task<DsfHTTPResponse<object>> AddSubLedger(string ledger)
        {
            AccountingDbContext accountingDbContext = new AccountingDbContext(connString);
            using (var dbContextTransaction = accountingDbContext.Database.BeginTransaction())
            {
        ...
        //    DsfHTTPResponse<object> responseData = new DsfHTTPResponse<object>();//type 'object' since we have variable return types
        ...
        //        //if (reqType == "AddLedgers")
        //        //{
        //        //    LedgerModel ledger = DsfJSONConvert.DeserializeObject<LedgerModel>(str);
        ...
        //        //                var flag = DsfEMR.AccTransfer.AccountingTransferData.LedgerAddUpdateInBalanceHisotry(ledger, accountingDBContext, false, currentHospitalId, currentUser.EmployeeId);
        ...
        //        //    List<LedgerModel> Ledgrs = DsfJSONConvert.DeserializeObject<List<LedgerModel>>(str);
        ...
        //        //if (reqType == "AddVouchers")
        //        //{
        //        //    VoucherModel voucher = DsfJSONConvert.DeserializeObject<VoucherModel>(str);
        ...
        //        //if (reqType == "AddVoucherHead")
        //        //{
        //        //    VoucherHeadModel voucherHead = DsfJSONConvert.DeserializeObject<VoucherHeadModel>(str);
        ...
        //        //if (reqType == "AddLedgersGroup")
        //        //{
        //        //    LedgerGroupModel ledgerGrpData = DsfJSONConvert.DeserializeObject<LedgerGroupModel>(str);
        ...
        //        //if (reqType == "AddCostCenterItem")
        //        //{
        //        //    CostCenterItemModel costCenterMod = DsfJSONConvert.DeserializeObject<CostCenterItemModel>(str);
        ...
        //        //if (reqType == "AddLedgerGroupCategory")
        //        //{
        //        //    LedgerGroupCategoryModel ledGrpCatMod = DsfJSONConvert.DeserializeObject<LedgerGroupCategoryModel>(str);
        ...
        //        //if (reqType == "AddSection")
        //        //{
        //        //    AccSectionModel section = DsfJSONConvert.DeserializeObject<AccSectionModel>(str);
        ...
        //        if (reqType == "AddCOA")
        //        {
        //            ChartOfAccountModel coa = DsfJSONConvert.DeserializeObject<ChartOfAccountModel>(str);
        ...
        //{
        //    try
        //    {FiscalYearModel fs = DsfJSONConvert.DeserializeObject<FiscalYearModel>(str);
        ...
        //if (reqType == "updateLedgerGrpIsActive")
        //{
        //    LedgerGroupModel ledgerGrp = DsfJSONConvert.DeserializeObject<LedgerGroupModel>(str);
        ...
        //if (reqType == "updateLedgerGroup")
        //{
        //    LedgerGroupModel ledgerGroup = DsfJSONConvert.DeserializeObject<LedgerGroupModel>(str);
        ...
        //if (reqType == "updateCostCenterItemStatus")
        //{
        //    CostCenterItemModel ccImodel = DsfJSONConvert.DeserializeObject<CostCenterItemModel>(str);
        ...
        //if (reqType == "updateLedgerGrpCategoryIsActive")
        //{
        //    LedgerGroupCategoryModel ledgerGrpCat = DsfJSONConvert.DeserializeObject<LedgerGroupCategoryModel>(str);
        ...
        //if (reqType == "UpdateVoucherHead")
        //{
        //    VoucherHeadModel voucher = DsfJSONConvert.DeserializeObject<VoucherHeadModel>(str);
        ...
        //if (reqType == "UpdateSection")
        //{
        //    AccSectionModel clientsection = DsfJSONConvert.DeserializeObject<AccSectionModel>(str);
        ...
        //if (reqType == "UpdateTransferRulesActive")
        //{
        //    string rulename = DsfJSONConvert.DeserializeObject<string>(str);
        ...
        public async Task<IActionResult> ActivateDeactivateCostCenter()
        {
            ...
            {
                string str = this.ReadPostData();
                CostCenterModel costCenter = DsfJSONConvert.DeserializeObject<CostCenterModel>(str);
                var costCenterDetail = await _accountingDbContext.CostCenters.Where(cc => cc.CostCenterId == costCenter.CostCenterId).FirstOrDefaultAsync();
                costCenterDetail.ModifiedBy = currentUser.EmployeeId;
                costCenterDetail.ModifiedOn = DateTime.Now;
        ...
        {
            int currentHospitalId = HttpContext.Session.Get<int>(ENUM_SessionValues.CurrentHospitalId);
            LedgerModel ledger = DsfJSONConvert.DeserializeObject<LedgerModel>(ipDataStr);
            //check for duplicate and don't allow to addd if found.
            //match with current hospital id, and don't allow to add same ledger. 
            ...
            else
            {
                using (var dbContextTransaction = _accountingDbContext.Database.BeginTransaction())
                {
                    try
                    {
                        ...
                        var flag = DsfEMR.AccTransfer.AccountingTransferData.LedgerAddUpdateInBalanceHisotry(ledger, _accountingDbContext, false, currentHospitalId, currentUser.EmployeeId);
                        // Dev: 4 Jan '23 : Add Default SubLedger for each ledger 
                        var subLedger = new SubLedgerModel();
        ...
        private object AddLedgerList(string ipDataStr, RbacUser currentUser)
        {
            int currentHospitalId = HttpContext.Session.Get<int>(ENUM_SessionValues.CurrentHospitalId);
            InventoryDbContext inventoryDBContext = new InventoryDbContext(connString);
            List<LedgerModel> Ledgrs = DsfJSONConvert.DeserializeObject<List<LedgerModel>>(ipDataStr);
            ...
            var parmValue = DsfJSONConvert.DeserializeObject<SubLedgerAndCostCenterConfig_DTO>(subLedgerParam);
            bool ledBalnce = false;
            using (var dbContextTransaction = _accountingDbContext.Database.BeginTransaction())
            {
                try
        ...
        {
            VoucherModel voucher = DsfJSONConvert.DeserializeObject<VoucherModel>(ipDataStr);
        ...
        {
            int currentHospitalId = HttpContext.Session.Get<int>(ENUM_SessionValues.CurrentHospitalId);
            VoucherHeadModel voucherHead = DsfJSONConvert.DeserializeObject<VoucherHeadModel>(ipDataStr);
        ...
        private object AddLedgersGroup(string ipDataStr, RbacUser currentUser)
        {
            ...
            //if (reqType == "AddLedgersGroup")
            int currentHospitalId = HttpContext.Session.Get<int>(ENUM_SessionValues.CurrentHospitalId);
            LedgerGroupModel ledgerGrpData = DsfJSONConvert.DeserializeObject<LedgerGroupModel>(ipDataStr);
        ...
        {
            int currentHospitalId = HttpContext.Session.Get<int>(ENUM_SessionValues.CurrentHospitalId);
            CostCenterItemModel costCenterMod = DsfJSONConvert.DeserializeObject<CostCenterItemModel>(ipDataStr);
            costCenterMod.CreatedOn = System.DateTime.Now;
            costCenterMod.CreatedBy = currentUser.UserId;
            costCenterMod.HospitalId = currentHospitalId;
        ...
        {
            int currentHospitalId = HttpContext.Session.Get<int>(ENUM_SessionValues.CurrentHospitalId);
            LedgerGroupCategoryModel ledGrpCatMod = DsfJSONConvert.DeserializeObject<LedgerGroupCategoryModel>(ipDataStr);
            ledGrpCatMod.CreatedOn = System.DateTime.Now;
            ledGrpCatMod.CreatedBy = currentUser.UserId;
        ...
        {
            int currentHospitalId = HttpContext.Session.Get<int>(ENUM_SessionValues.CurrentHospitalId);
            AccSectionModel section = DsfJSONConvert.DeserializeObject<AccSectionModel>(ipDataStr);
            section.HospitalId = currentHospitalId;
        ...
        {
            ChartOfAccountModel coa = DsfJSONConvert.DeserializeObject<ChartOfAccountModel>(ipDataStr);
            coa.CreatedOn = System.DateTime.Now;
            coa.CreatedBy = currentUser.UserId;
            coa.ModifiedBy = null;
        ...
        private object UpdateReopenFiscalYear(string ipDataStr, RbacUser currentuser)
        {
            ...
            {
                int currentHospitalId = HttpContext.Session.Get<int>(ENUM_SessionValues.CurrentHospitalId);
                FiscalYearModel fs = DsfJSONConvert.DeserializeObject<FiscalYearModel>(ipDataStr);
        ...
        {
            LedgerGroupModel ledgerGrp = DsfJSONConvert.DeserializeObject<LedgerGroupModel>(ipDataStr);
        ...
        {
            int currentHospitalId = HttpContext.Session.Get<int>(ENUM_SessionValues.CurrentHospitalId);
            LedgerGroupModel ledgerGroup = DsfJSONConvert.DeserializeObject<LedgerGroupModel>(ipDataStr);
        ...
        {
            CostCenterItemModel ccImodel = DsfJSONConvert.DeserializeObject<CostCenterItemModel>(ipDataStr);
        ...
        {
            LedgerGroupCategoryModel ledgerGrpCat = DsfJSONConvert.DeserializeObject<LedgerGroupCategoryModel>(ipDataStr);
        ...
        {
            VoucherHeadModel voucher = DsfJSONConvert.DeserializeObject<VoucherHeadModel>(ipDataStr);
        ...
        {
            AccSectionModel clientsection = DsfJSONConvert.DeserializeObject<AccSectionModel>(ipDataStr);
        ...
        {
            string rulename = DsfJSONConvert.DeserializeObject<string>(ipDataStr);
