    ...
    public class BillSettingsController : CommonController
    {
        ...
        private object AddBillScheme(string ipDataStr, RbacUser currentUser)
        {
            using (var schemeTransactionScope = _billingDbContext.Database.BeginTransaction())
            {
                try
                {
                    BillingSchemeModel billingScheme = DsfJSONConvert.DeserializeObject<BillingSchemeModel>(ipDataStr);
        ...
        private object UpdateBillScheme(string ipDataStr, RbacUser CurrentUser)
        {
            using (var schemeTransactionScope = _billingDbContext.Database.BeginTransaction())
            {
                BillingSchemeModel billScheme = DsfJSONConvert.DeserializeObject<BillingSchemeModel>(ipDataStr);
                try
                {
                    if (billScheme != null)
                    {
        ...
        {
            ServiceDepartmentModel servdeptModel = DsfJSONConvert.DeserializeObject<ServiceDepartmentModel>(ipDataStr);
        ...
        private object AddingBillingItem(string ipDataStr, RbacUser currentUser)
        {
            ...
            BillServiceItemModel item = DsfJSONConvert.DeserializeObject<BillServiceItemModel>(ipDataStr);
        ...
        {
            ReportingItemsModel item = DsfJSONConvert.DeserializeObject<ReportingItemsModel>(ipDataStr);
        ...
        {
            List<ReportingItemBillingItemMapping> mappingObject = DsfJSONConvert.DeserializeObject<List<ReportingItemBillingItemMapping>>(ipDataStr);
        ...
        {
            CreditOrganizationModel org = DsfJSONConvert.DeserializeObject<CreditOrganizationModel>(ipDataStr);
        ...
        {
            BillingSchemeModel scheme = DsfJSONConvert.DeserializeObject<BillingSchemeModel>(ipDataStr);
        ...
        {
            PrinterSettingsModel printerSetting = DsfJSONConvert.DeserializeObject<PrinterSettingsModel>(ipDataStr);
        ...
        private object AddingBillItemsPriceCategoryMap(string ipDataStr, RbacUser currentUser)
        {
            try
            {
                BillCfgItemsVsPriceCategoryDto billCfgItemsVsPriceCategoryDto = DsfJSONConvert.DeserializeObject<BillCfgItemsVsPriceCategoryDto>(ipDataStr);
        ...
        {
            ServiceDepartmentModel clientServDept = DsfJSONConvert.DeserializeObject<ServiceDepartmentModel>(ipDataStr);
        ...
        {
            CreditOrganizationModel creditOrganization = DsfJSONConvert.DeserializeObject<CreditOrganizationModel>(ipDataStr);
        ...
        private object UpdateBillItemsPriceCategoryMap(string ipDataStr, RbacUser currentUser, int PriceCategoryMapId)
        {
            try
            {
                BillMapPriceCategoryServiceItemModel billItemsPriceCategoryMap = DsfJSONConvert.DeserializeObject<BillMapPriceCategoryServiceItemModel>(ipDataStr);
        ...
        public string Post()
        {
            ...
            try
            {
                ...
                if (reqType == "post-service-department")
                {
                    ...
                    ServiceDepartmentModel servdeptModel = DsfJSONConvert.DeserializeObject<ServiceDepartmentModel>(str);
                ...
                if (reqType == "post-billing-item")
                {
                    ...
                    BillItemPrice item = DsfJSONConvert.DeserializeObject<BillItemPrice>(str);

                    //MapBillItemsAndPriceCategory mapBillItemsAndPriceCategory = DsfJSONConvert.DeserializeObject<MapBillItemsAndPriceCategory>(str);
                ...
                if (reqType == "post-reportingItem")
                {
                    ...
                    ReportingItemsModel item = DsfJSONConvert.DeserializeObject<ReportingItemsModel>(str);
                ...
                if (reqType == "post-security-reportingItemBillItem")
                {
                    List<ReportingItemBillingItemMapping> mappingObject = DsfJSONConvert.DeserializeObject<List<ReportingItemBillingItemMapping>>(str);
                    mappingObject.ForEach(mapping =>
                    {
                ...
                if (reqType == "post-billing-package")
                {
                    BillingPackageModel package = DsfJSONConvert.DeserializeObject<BillingPackageModel>(str);
                ...
                if (reqType == "post-credit-organization")
                {
                    CreditOrganizationModel org = DsfJSONConvert.DeserializeObject<CreditOrganizationModel>(str);
                ...
                if (reqType == "post-membership-type")
                {
                    MembershipTypeModel mem = DsfJSONConvert.DeserializeObject<MembershipTypeModel>(str);
                ...
                if (reqType == "post-printer-setting")
                {
                    PrinterSettingsModel printerSetting = DsfJSONConvert.DeserializeObject<PrinterSettingsModel>(str);
                    printerSetting.IsActive = true;
                    printerSetting.CreatedBy = currentUser.EmployeeId;
                    printerSetting.CreatedOn = DateTime.Now;
        ...
        public string Put()
        {
            ...
            try
            {
               if (reqType == "put-service-department")
               {
                   ...
                   ServiceDepartmentModel clientServDept = DsfJSONConvert.DeserializeObject<ServiceDepartmentModel>(str);
                   if (clientServDept.IntegrationName == "None")
                   {
                       clientServDept.IntegrationName = null;
                   }
               ...
               {
                   CreditOrganizationModel creditOrganization = DsfJSONConvert.DeserializeObject<CreditOrganizationModel>(str);
               ...
               {
                   MembershipTypeModel membership = DsfJSONConvert.DeserializeObject<MembershipTypeModel>(str);
