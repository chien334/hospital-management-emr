...
namespace DsfEMR.Controllers.Doctors
{
    public class VisitSummaryController : CommonController
    {
        ...
        {
                List<VisitSummaryModel> patDataList = DsfJSONConvert.DeserializeObject<List<VisitSummaryModel>>(ipStr);
        ...
        {
                List<VisitSummaryModel> patDataList = DsfJSONConvert.
