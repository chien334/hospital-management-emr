...
namespace DsfEMR.Controllers
{
    public class AssetMaintenanceController : CommonController
    {
        ...
        public IActionResult GetAll([FromRoute] int StoreId)
        {
            ...
            var resData = new DsfHTTPResponse<object>();
        ...
        public IActionResult PostAssetServiceDetails()
        {
            ...
            try
            {
                ...
                FixedAssetServiceModel serviceDetails = DsfJSONConvert.DeserializeObject<FixedAssetServiceModel>(Str);
        ...
        public IActionResult PutAssetRequiredMaintenance()
        {
            ...
            try
            {
                ...
                FixedAssetStockModel assetDetails = DsfJSONConvert.DeserializeObject<FixedAssetStockModel>(Str);
        ...
        public IActionResult PutAssetFaultResolvedDetails()
        {
            ...
            {
                var Str = this.ReadPostData();
                FixedAssetFaultHistoryModel assetDetails = DsfJSONConvert.DeserializeObject<FixedAssetFaultHistoryModel>(Str);
        ...
        public IActionResult PostAssetContractFile()
        {
            ...
            try
            {
                ...
                FixedAssetContractModel fileDetails = DsfJSONConvert.DeserializeObject<FixedAssetContractModel>(FD);
        ...
        public IActionResult UpdateAssetDamageStatus()
        {
            ...
            try
            {
                ...
                string str = this.ReadPostData();
                FixedAssetStockModel faStock = DsfJSONConvert.DeserializeObject<FixedAssetStockModel>(str);
                RbacUser currentUser = HttpContext.Session.Get<RbacUser>("currentuser");
        ...
        public IActionResult AssetFaultUpdate()
        {
            ...
            try
            {
                ...
                string Str = this.ReadPostData();
                FixedAssetFaultHistoryModel faulthistory = DsfJSONConvert.DeserializeObject<FixedAssetFaultHistoryModel>(Str);
        ...
        public IActionResult AssetCheckList()
        {
            ...
            try
            {
                ...
                string Str = this.ReadPostData();
                List<FixedAssetConditionCheckListModel> asstechecklist = DsfJSONConvert.DeserializeObject<List<FixedAssetConditionCheckListModel>>(Str);
                RbacUser currentUser = HttpContext.Session.Get<RbacUser>("currentuser");
        ...
        public IActionResult UpdateAssetMaintenanceList()
        {
            ...
            try
            {
                ...
                string str = this.ReadPostData();
                FixedAssetStockModel fixedAssetstock = DsfJSONConvert.DeserializeObject<FixedAssetStockModel>(str);
