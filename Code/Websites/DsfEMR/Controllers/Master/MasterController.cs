...
using DsfEMR.ServerModel.EmergencyModels;
...
namespace DsfEMR.Controllers
{
    ...
    public class MasterController : CommonController
    {
        ...
        {
            //if (type == "department")
            List<DepartmentModel> deptList = (List<DepartmentModel>)DsfCache.GetMasterData(MasterDataEnum.Department);
        ...
        public IActionResult Countries()
        {
            ...
            var formatedResult = new DsfHTTPResponse<List<CountryModel>>() { Results = Country, Status = "OK" };
            return InvokeHttpGetFunction(func);
        }
        ...
        public IActionResult GetEmployeeDepartment(int employeeId)
        {
            ...
            Func<object> func = () => (List<EmployeeModel>)DsfCache.GetMasterData(MasterDataEnum.Employee);
            DepartmentModel department = (from d in deptList
                                          join e in empListFromCache on d.DepartmentId equals e.DepartmentId
                                          where e.EmployeeId == employeeId
                                          select d).FirstOrDefault();
            var formatedResult = new DsfHTTPResponse<DepartmentModel>() { Results = department, Status = "OK" };
            return InvokeHttpGetFunction(func);
        }
        ...
        //    //    //add into DsfHTTPResponse format.
        //    //    var formatedResult = new DsfHTTPResponse<List<DepartmentModel>>() { Results = filteredList, Status = "OK" };
        //    //    returnValue = DsfJSONConvert.SerializeObject(formatedResult, true);
        //    //    return returnValue;
        ...
        //    //    }
        //    //    var formatedResult = new DsfHTTPResponse<List<CountrySubDivisionModel>>() { Results = CountrySubDivision, Status = "OK" };
        //    //    returnValue = DsfJSONConvert.SerializeObject(formatedResult, true);
        ...
        //    //        var formattedResult = new DsfHTTPResponse<object>()
        //    //        {
        //    //            Results = retData,
        //    //            Status = "OK"
        //    //        };
        //    //        returnValue = DsfJSONConvert.SerializeObject(formattedResult, true);
        //    //    }
        //    //    catch (Exception ex)
        //    //    {
        //    //        throw ex;
        ...
        //    //        if (reqType == "appointment")
        //    //        {
        //    //            // List<DepartmentModel> allDeptsFromCache = (List<DepartmentModel>)DsfCache.GetMasterData(MasterDataEnum.Department);
        ...
        //    //    var formattedList = new DsfHTTPResponse<List<EmployeeModel>>() { Results = filteredList, Status = status };
        //    //    returnValue = DsfJSONConvert.SerializeObject(formattedList, true);
        //    //    return returnValue;
        ...
        //    //                        select emp).OrderBy(e => e.DisplaySequence).ToList();
        //    //    }
        //    //    var formattedList = new DsfHTTPResponse<List<EmployeeModel>>() { Results = filteredList, Status = "OK" };
        //    //    returnValue = DsfJSONConvert.SerializeObject(formattedList, true);
        //    //    return returnValue;
        ...
        //    //{
        //    //    //get the value from dsfcache
        //    //    List<ICD10CodeModel> icdListFrmCache = (List<ICD10CodeModel>)DsfCache.GetMasterData(MasterDataEnum.ICD10);
        ...
        //    //    //add into DsfHTTPResponse format.
        //    //    var formatedResult = new DsfHTTPResponse<List<ICD10CodeModel>>() { Results = filteredList, Status = "OK" };
        //    //    returnValue = DsfJSONConvert.SerializeObject(formatedResult, true);
        //    //    return returnValue;
        //    //}
        ...
        //    //{
        //    //    //get the value from dsfcache
        //    //    List<EmployeeModel> employeeFrmCache = (List<EmployeeModel>)DsfCache.GetMasterData(MasterDataEnum.Employee);
        ...
        //    //    //add into DsfHTTPResponse format.
        //    //    var formatedResult = new DsfHTTPResponse<List<EmployeeModel>>() { Results = filteredList, Status = "OK" };
        //    //    returnValue = DsfJSONConvert.SerializeObject(formatedResult, true);
        //    //}
        ...
        //    //{
        //    //    //get the value from dsfcache
        //    //    List<PHRMItemMasterModel> medicineFrmCache = (List<PHRMItemMasterModel>)DsfCache.GetMasterData(MasterDataEnum.Medicine);
        ...
        //    //    //add into DsfHTTPResponse format.
        //    //    var formatedResult = new DsfHTTPResponse<List<PHRMItemMasterModel>>() { Results = filteredList, Status = "OK" };
        //    //    returnValue = DsfJSONConvert.SerializeObject(formatedResult, true);
        //    //}
        ...
        //    //{
        //    //    //get the value from dsfcache
        //    //    List<ReactionModel> reactionFrmCache = (List<ReactionModel>)DsfCache.GetMasterData(MasterDataEnum.Reaction);
        ...
        //    //    //add into DsfHTTPResponse format.
        //    //    var formatedResult = new DsfHTTPResponse<List<ReactionModel>>() { Results = filteredList, Status = "OK" };
        //    //    returnValue = DsfJSONConvert.SerializeObject(formatedResult, true);
        //    //}
        //    //else
        ...
        //    //{
        //    //    //get the value from dsfcache
        //    //    List<RadiologyImagingItemModel> imagingitemFrmCache = (List<RadiologyImagingItemModel>)DsfCache.GetMasterData(MasterDataEnum.ImagingItems);
        ...
        //    //        }
        //    //    }
        //    //    var formattedList = new DsfHTTPResponse<List<RadiologyImagingItemModel>>() { Results = filteredList, Status = status };
        //    //    returnValue = DsfJSONConvert.SerializeObject(formattedList, true);
        //    //    return returnValue;
        //    //}
        //    //else 
        ...
        //    //    var formatedResult = new DsfHTTPResponse<List<WardModel>>() { Results = wardList, Status = "OK" };
        //    //    returnValue = DsfJSONConvert.SerializeObject(formatedResult, true);
        //    //}
        //    //else 
        ...
        //    //if (type == "AllMasters")
        //    //{
        //    //    List<ServiceDepartmentModel> srvDeptList = (List<ServiceDepartmentModel>)DsfCache.GetMasterData(MasterDataEnum.ServiceDepartment);
        //    //    List<PriceCategoryModel> priceCategoryList = (List<PriceCategoryModel>)DsfCache.GetMasterData(MasterDataEnum.PriceCategory);
        //    //    List<DepartmentModel> departments = (List<DepartmentModel>)DsfCache.GetMasterData(MasterDataEnum.Department);
        //    //    List<TaxModel> taxes = (List<TaxModel>)DsfCache.GetMasterData(MasterDataEnum.Taxes);
        //    //    UniquePastDataModel allPastPatUniqueData = (UniquePastDataModel)DsfCache.GetMasterData(MasterDataEnum.PastUniqueData);
        //    //    List<ICD10CodeModel> icd10List = (List<ICD10CodeModel>)DsfCache.GetMasterData(MasterDataEnum.ICD10);
        ...
        //    //    returnValue = DsfJSONConvert.SerializeObject(responseData, true);
        //    //}
        //    //else 
        ...
        //    //    }
        //    //    var formatedResult = new DsfHTTPResponse<List<BedTypeModel>>() { Results = bedTypeList, Status = "OK" };
        //    //    returnValue = DsfJSONConvert.SerializeObject(formatedResult, true);
        //    //}
        ...
        //    //                   select bed).ToList();
        //    //    }
        //    //    var formatedResult = new DsfHTTPResponse<List<BedModel>>() { Results = bedList, Status = "OK" };
        //    //    returnValue = DsfJSONConvert.SerializeObject(formatedResult, true);
        //    //}
