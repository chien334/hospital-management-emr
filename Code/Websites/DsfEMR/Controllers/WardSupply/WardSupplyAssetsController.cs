...
using DsfEMR.ViewModel.FixedAsset; //swapnil-2-april-2021
...
namespace DsfEMR.Controllers
{
    public class WardSupplyAssetsController : CommonController
    {
        ...
        //        {
        //            string Str = this.ReadPostData();
        //            WARDSupplyAssetRequisitionModel RequisitionFromClient = DsfJSONConvert.
        ...
        public IActionResult PostStoreDispatch()
        {
            ...
            {
                string Str = this.ReadPostData();
                FixedAssetDispatchModel DispatchFromClient = DsfJSONConvert.DeserializeObject<FixedAssetDispatchModel>(Str);
        ...
        private object AddAssetRequisition(string Str, RbacUser currentUser)
        {
            ...
            WARDSupplyAssetRequisitionModel RequisitionFromClient = DsfJSONConvert.DeserializeObject<WARDSupplyAssetRequisitionModel>(Str);
            List<WARDSupplyAssetRequisitionItemsModel> requisitionItems = new List<WARDSupplyAssetRequisitionItemsModel>();
            WARDSupplyAssetRequisitionModel requisition = new WARDSupplyAssetRequisitionModel();
