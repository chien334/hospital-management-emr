...
namespace DsfEMR.Controllers.Billing
{
    public class BillingMasterController : CommonController
    {
        ...
        [HttpGet]
        [Route("ServiceItems")]
        [Produces(typeof(DsfHTTPResponse<List<ServiceItemDetails_DTO>>))]
        ...
        [HttpGet]
        [Route("Schemes")]
        [Produces(typeof(DsfHTTPResponse<BillingScheme_DTO>))]
        ...
        [Produces(typeof(DsfHTTPResponse<List<PriceCategoryModel>>))]
        ...
        [Produces(typeof(DsfHTTPResponse<List<CreditOrganizationModel>>))]
