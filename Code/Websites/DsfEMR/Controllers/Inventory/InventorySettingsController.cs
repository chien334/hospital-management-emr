   ...
   */
    ...
    responseData.Results = otherCharges;
        ...
        private object PostNewVendorDetail()
        {
            ...
            VendorMasterModel vendorModel = DsfJSONConvert.DeserializeObject<VendorMasterModel>(str);
        ...
        {
            string str = this.ReadPostData();
            ItemCategoryMasterModel itemcategoryModel = DsfJSONConvert.DeserializeObject<ItemCategoryMasterModel>(str);
        ...
        private object PostItemSubCategoryDetail()
        {
            ...
            {
                string str = this.ReadPostData();
                ItemSubCategoryMasterModel itemsubcategoryModel = DsfJSONConvert.DeserializeObject<ItemSubCategoryMasterModel>(str);
        ...
        {
            string str = this.ReadPostData();
            InventoryTermsModel termsconditions = DsfJSONConvert.DeserializeObject<InventoryTermsModel>(str);
        ...
        {
            string str = this.ReadPostData();
            UnitOfMeasurementMasterModel unitofmeasurementModel = DsfJSONConvert.DeserializeObject<UnitOfMeasurementMasterModel>(str);
        ...
        {
            string str = this.ReadPostData();
            PackagingTypeMasterModel packagingtypeModel = DsfJSONConvert.DeserializeObject<PackagingTypeMasterModel>(str);
        ...
        {
            string str = this.ReadPostData();
            AccountHeadMasterModel accountheadModel = DsfJSONConvert.DeserializeObject<AccountHeadMasterModel>(str);
        ...
        {
            string str = this.ReadPostData();
            ItemMasterModel itemModel = DsfJSONConvert.DeserializeObject<ItemMasterModel>(str);
        ...
        {
            string str = this.ReadPostData();
            CurrencyMasterModel currencyModel = DsfJSONConvert.DeserializeObject<CurrencyMasterModel>(str);
        ...
        {
            string str = this.ReadPostData();
            InventoryChargesMasterModel otherChargesModel = DsfJSONConvert.DeserializeObject<InventoryChargesMasterModel>(str);
        ...
        {
            string str = this.ReadPostData();
            VendorMasterModel vendor = DsfJSONConvert.DeserializeObject<VendorMasterModel>(str);
        ...
        {
            string str = this.ReadPostData();
            InventoryChargesMasterModel chargeModel = DsfJSONConvert.DeserializeObject<InventoryChargesMasterModel>(str);
