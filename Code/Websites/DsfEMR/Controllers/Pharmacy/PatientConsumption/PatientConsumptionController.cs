...
using DsfEMR.ServerModel.PharmacyModels.Patient_Consumption;
using DsfEMR.ServerModel.SSFModels.ClaimResponse;
using DsfEMR.Services.Dispensary.DTOs.PharmacyConsumption;
using DsfEMR.Services.Dispensary.DTOs.PharmacyPatientConsumption;
...
namespace DsfEMR.Controllers.Pharmacy.PatientConsumption
{
