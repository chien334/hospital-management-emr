...
using DsfEMR.ServerModel.InventoryModels.DTOs;
using DsfEMR.Services;
using DsfEMR.Services.Inventory.DTO.InventoryRequisition;
using DsfEMR.Services.Inventory.DTO.RequisitionDispatch;
using DsfEMR.Services.Verification;
using DsfEMR.Services.WardSupply.Inventory.Requisition.DTOs;
using DsfEMR.Utilities;
using DsfEMR.ViewModel;
using DsfEMR.ViewModel.Inventory;
using DsfEMR.ViewModel.Procurement;
...
namespace DsfEMR.Controllers
{
    ...
    public class InventoryController : CommonController
    {
        ...
        private object GetVendorsList()
        {
            ...
            {
                vendor.DefaultItem = DsfJSONConvert.DeserializeObject<List<int>>(vendor.DefaultItemJSON);
            }
            return VendorList;
        }
        ...
        public IActionResult GetAllSubstoreRequistionList(DateTime fromDate, DateTime toDate, int storeId)
        {
            ...
            try
            {
                ...
                foreach (var Requisition in RequisitionList)
                {
                    Requisition.MaxVerificationLevel = Requisition.VerifierIds != null ? DsfJSONConvert.DeserializeObject<List<dynamic>>(Requisition.VerifierIds).Count() : 0;
                    if (Requisition.VerificationId != null)
                    {
                        Requisition.CurrentVerificationLevelCount = VerificationBL.GetNumberOfVerificationDone(inventoryDbContext, Requisition.VerificationId ?? 0);
                    }
        ...
        public IActionResult TrackRequisitionByRequisitionId(int requisitionId)
        {
            ...
            try
            {
                ...
                inventoryRequisitionVM.MaxVerificationLevel = requisition.VerifierIds != null ? DsfJSONConvert.DeserializeObject<List<Verifier_DTO>>(requisition.VerifierIds).Count() : 0;
        ...
        private object PostPORequisition()
        {
            ...
            PurchaseRequestModel reqFromClient = DsfJSONConvert.DeserializeObject<PurchaseRequestModel>(Str);
            RbacUser currentUser = HttpContext.Session.Get<RbacUser>("currentuser");
        ...
        private object PostRequestForQuotation()
        {
            RbacUser currentUser = HttpContext.Session.Get<RbacUser>("currentuser");
            string Str = this.ReadPostData();
            RequestForQuotation reqForQuotation = DsfJSONConvert.DeserializeObject<RequestForQuotation>(Str);
        ...
        private object PostQuotationFiles()
        {
            ...
            QuotationUploadedFiles quotationFileData = DsfJSONConvert.DeserializeObject<QuotationUploadedFiles>(quotationDetails);
            RbacUser currentUser = HttpContext.Session.Get<RbacUser>("currentuser");
        ...
        private object PostQuotationsDetails()
        {
            using (var dbTransaction = _inventoryDbContext.Database.BeginTransaction())
            {
                try
                {
                    var currentDate = DateTime.Now;
                    string Str = this.ReadPostData();
                    List<Quotation> quotationDataFromClient = DsfJSONConvert.DeserializeObject<List<Quotation>>(Str);
                    RbacUser currentUser = HttpContext.Session.Get<RbacUser>("currentuser");
        ...
        private object PostDispatch()
        {
            ...
            DispatchModel dispatch = DsfJSONConvert.DeserializeObject<DispatchModel>(Str);
        ...
        {
            string Str = this.ReadPostData();
            List<WriteOffItemsModel> writeItemsFromClient = DsfJSONConvert.DeserializeObject<List<WriteOffItemsModel>>(Str);
        ...
        {
            string Str = this.ReadPostData();
            //List<ReturnToVendorModel> retrnToVendor = DsfJSONConvert.DeserializeObject<List<ReturnToVendorModel>>(Str);

            ReturnToVendorModel retrnToVendor = DsfJSONConvert.DeserializeObject<ReturnToVendorModel>(Str);
            //List<ReturnToVendorItemsModel> retrnToVendor = DsfJSONConvert.DeserializeObject<List<ReturnToVendorItemsModel>>(Str);
        ...
        {
            string Str = this.ReadPostData();
            RequisitionModel RequisitionFromClient = DsfJSONConvert.DeserializeObject<RequisitionModel>(Str);
            ...
            using (var dbContextTransaction = _inventoryDbContext.Database.BeginTransaction())
            {
                try
                {
                    ...
                    var currentDate = DateTime.Now;
                    RequisitionModel requisition = DsfJSONConvert.DeserializeObject<RequisitionModel>(DsfJSONConvert.SerializeObject(requisitionDTO));
        ...
        private static string SerializeVerifiers(List<Verifier_DTO> verifiers)
        {
            if (verifiers != null && verifiers.Count() > 0)
            {
                ...
                return DsfJSONConvert.SerializeObject(VerifierList).Replace(" ", String.Empty);
            }
            return null;
        }
        ...
        {
            string Str = this.ReadPostData();
            List<InventoryStockModel> stock = DsfJSONConvert.DeserializeObject<List<InventoryStockModel>>(Str);
            var responseData = new DsfHTTPResponse<object>();
        ...
        {
            string str = this.ReadPostData();
            PurchaseOrderModel PurchaseOrderFromClient = DsfJSONConvert.
        ...
        private object UpdateRequisitionStatusData()
        {
            string str = this.ReadPostData();
            RbacUser currentUser = HttpContext.Session.Get<RbacUser>("currentuser");
            RequisitionModel RequistionFromClient = DsfJSONConvert.
        ...
        private object UpdateStockManageDetail()
        {
            string str = this.ReadPostData();
            RbacUser currentUser = HttpContext.Session.Get<RbacUser>("currentuser");
            List<InventoryStockManage> inventoryStockManage = DsfJSONConvert.DeserializeObject<List<InventoryStockManage>>(str);
        ...
        {
            string str = this.ReadPostData();
            Quotation quotData = DsfJSONConvert.DeserializeObject<Quotation>(str);
        ...
        {
            string Str = this.ReadPostData();
            PurchaseOrderModel poFromClient = DsfJSONConvert.DeserializeObject<PurchaseOrderModel>(Str);
            RbacUser currentUser = HttpContext.Session.Get<RbacUser>("currentuser");
            if (poFromClient != null && poFromClient.PurchaseOrderItems != null && poFromClient.PurchaseOrderItems.Count > 0)
            {
                using (var dbTransaction = _inventoryDbContext.Database.BeginTransaction())
        ...
        {
            string Str = this.ReadPostData();
            PurchaseRequestModel purchaseRequestFromClient = DsfJSONConvert.DeserializeObject<PurchaseRequestModel>(Str);
            RbacUser currentUser = HttpContext.Session.Get<RbacUser>("currentuser");
        ...
        {
            string Str = this.ReadPostData();
            int? reqId = DsfJSONConvert.DeserializeObject<int?>(Str);
        ...
        {
            string Str = this.ReadPostData();
            RequisitionModel reqFromClientC = DsfJSONConvert.DeserializeObject<RequisitionModel>(Str);
            RbacUser currentUser = HttpContext.Session.Get<RbacUser>("currentuser");
