...
namespace DsfEMR.Controllers
{
    ...
    public class BillSettlementController : CommonController
    {
        ...
        private object GetAllPendingSettlements(int organizationId)
        {
            ...
            DataTable settlInfo = DsfEMR.DalLayer.DALFunctions.GetDataTableFromStoredProc("SP_TXNS_BILL_SettlementSummary", paramList, _billingDbContext);
        ...
        private object SaveSettlement(string ipDataString, RbacUser currentUser)
        {
            ...
            BillSettlementModel settlement = DsfJSONConvert.DeserializeObject<BillSettlementModel>(ipDataString);
