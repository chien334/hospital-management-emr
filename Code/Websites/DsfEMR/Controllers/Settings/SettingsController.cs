...
using DsfEMR.ServerModel.WardSupplyModels;
using DsfEMR.Services.DepartmentSettings.DTOs;
    ...
    public class SettingsController : CommonController
    {
        ...
        public async Task<string> UpdatePaymentModeSettings()
        {
            ...
            try
            {
                ...
                List<CfgPaymentModesSettings> cfgPaymentModesSettings = DsfJSONConvert.DeserializeObject<List<CfgPaymentModesSettings>>(strPaymentsMode);
        ...
        public async Task<string> UpdateServiceDepartmentStatus()
        {
            ...
            try
            {
                ...
                ServiceDepartmentModel serviceDepartment = DsfJSONConvert.DeserializeObject<ServiceDepartmentModel>(strServiceDepartment);
        ...
        //        //if (reqType == "department")
        //        //{
        //        //    DepartmentModel deptModel = DsfJSONConvert.DeserializeObject<DepartmentModel>(str);
        ...
        //        //        try
        //        //        {
        //        //            PHRMStoreModel storeModel = DsfJSONConvert.DeserializeObject<PHRMStoreModel>(str);
        ...
        //        //if (reqType == "country")
        //        //{
        //        //    CountryModel countryModel = DsfJSONConvert.DeserializeObject<CountryModel>(str);
        ...
        //        //if (reqType == "subdivision")
        //        //{
        //        //    CountrySubDivisionModel subDivisionModel = DsfJSONConvert.DeserializeObject<CountrySubDivisionModel>(str);
        ...
        //        //if (reqType == "municipality")
        //        //{
        //        //    MunicipalityModel model = DsfJSONConvert.DeserializeObject<MunicipalityModel>(ipDataStr);
        ...
        //        //if (reqType == "reaction")
        //        //{
        //        //    ReactionModel rxnModel = DsfJSONConvert.DeserializeObject<ReactionModel>(ipDataStr);
        ...
        //        //if (reqType == "lab-item")
        //        //{
        //        //    LabTestModel labItem = DsfJSONConvert.DeserializeObject<LabTestModel>(ipDataStr);
        ...
        //        //if (reqType == "post-bank")
        //        //{
        //        //    BanksModel bankDetail = DsfJSONConvert.DeserializeObject<BanksModel>(ipDataStr);
        ...
        //        //if (reqType == "post-print-export-configuration")
        //        //{
        //        //    PrintExportConfigModel printExportConfigModel = DsfJSONConvert.DeserializeObject<PrintExportConfigModel>(ipDataStr);
        ...
        //            //if (reqType == "department")
        //            //{
        //            //    DepartmentModel clientDept = DsfJSONConvert.DeserializeObject<DepartmentModel>(str);
        ...
        //            //        try
        //            //        {
        //            //            int storeId = DsfJSONConvert.DeserializeObject<int>(ipDataStr);
        ...
        //            //        try
        //            //        {
        //            //            PHRMStoreModel store = DsfJSONConvert.DeserializeObject<PHRMStoreModel>(ipDataStr);
        ...
        //            //if (reqType == "country")
        //            //{
        //            //    CountryModel countryInfo = DsfJSONConvert.DeserializeObject<CountryModel>(ipDataStr);
        ...
        //            //if (reqType == "subdivision")
        //            //{
        //            //    CountrySubDivisionModel subdivInfo = DsfJSONConvert.DeserializeObject<CountrySubDivisionModel>(ipDataStr);
        ...
        //            //if (reqType == "reaction")
        //            //{
        //            //    ReactionModel rxnInfo = DsfJSONConvert.DeserializeObject<ReactionModel>(ipDataStr);
        ...
        //            //if (reqType == "put-bank")
        //            //{
        //            //    BanksModel bankDetail = DsfJSONConvert.DeserializeObject<BanksModel>(str);
        ...
        //            //if (reqType == "put-print-export-configuration")
        //            //{
        //            //    PrintExportConfigModel printExportConfigModel = DsfJSONConvert.DeserializeObject<PrintExportConfigModel>(str);
        ...
        private object SaveDepartment(string ipDataStr)
        {
            ...
            DepartmentModel deptModel = DsfJSONConvert.DeserializeObject<DepartmentModel>(ipDataStr);
        ...
        private object SaveStore(string ipDataStr, RbacUser currentUser)
        {
            using (var dbContextTransaction = _rbacDbContext.Database.BeginTransaction())
            {
                try
                {
                    PHRMStoreModel storeModel = DsfJSONConvert.DeserializeObject<PHRMStoreModel>(ipDataStr);
                    //create permission so that admin can create substore access right to the user
        ...
        private object SaveCountry(string ipDataStr)
        {
            ...
            CountryModel countryModel = DsfJSONConvert.DeserializeObject<CountryModel>(ipDataStr);
            countryModel.CreatedOn = System.DateTime.Now;
        ...
        {
            CountrySubDivisionModel subDivisionModel = DsfJSONConvert.DeserializeObject<CountrySubDivisionModel>(ipDataStr);
            subDivisionModel.CreatedOn = System.DateTime.Now;
        ...
        {
            DepartmentModel clientDept = DsfJSONConvert.DeserializeObject<DepartmentModel>(ipDataStr);
        ...
        private object UpdateCFGParameter(string ipDataStr)
        {
            ...
            CfgParameterModel parameter = DsfJSONConvert.DeserializeObject<CfgParameterModel>(ipDataStr);
