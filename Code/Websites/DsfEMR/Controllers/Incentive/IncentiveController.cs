...
namespace DsfEMR.Controllers
{
    public class IncentiveController : CommonController
    {
        ...
        {
            ProfileModel profileMaster = DsfJSONConvert.DeserializeObject<ProfileModel>(ipDataStr);
        ...
        {
            List<ProfileItemMap> profileItemMaps = DsfJSONConvert.DeserializeObject<List<ProfileItemMap>>(ipDataStr);
            Boolean flag = false;
        ...
        {
            EmployeeIncentiveInfo EmployeeIncentiveInfo = DsfJSONConvert.DeserializeObject<EmployeeIncentiveInfo>(ipDataStr);
        ...
        private object UpdateEmployeeBillItem(string ipDataStr, RbacUser currentUser)
        {
            try
            {
                EmployeeBillItemsMap employeeBillItem = DsfJSONConvert.DeserializeObject<EmployeeBillItemsMap>(ipDataStr);
        ...
        private object UpdateProfileBillItemMap(string ipDataStr, RbacUser currentUser)
        {
            try
            {
                ProfileItemMap ProfileBillItemMap = DsfJSONConvert.DeserializeObject<ProfileItemMap>(ipDataStr);
        ...
        {
            List<ItemGroupDistribution> itmGrpDistributionsFromClient = DsfJSONConvert.DeserializeObject<List<ItemGroupDistribution>>(ipDataStr);
            using (var dbContextTxn = _incentiveDbContext.Database.BeginTransaction())
            {
                try
                {
        ...
        {
            List<IncentiveFractionItemModel> fractionItems = DsfJSONConvert.DeserializeObject<List<IncentiveFractionItemModel>>(ipDataStr);
        ...
        {
            ProfileModel profile = DsfJSONConvert.DeserializeObject<ProfileModel>(ipDataStr);
        ...
        {
            ProfileModel profileData = DsfJSONConvert.DeserializeObject<ProfileModel>(ipDataStr);
        ...
        public string Post()
        {
            ...
            try
            {
                ...
                if (reqType == "addProfile")
                {
                    ProfileModel profileMaster = DsfJSONConvert.DeserializeObject<ProfileModel>(str);
                ...
                {
                    //List<EmployeeProfileMap> employeeProfiles = DsfJSONConvert.DeserializeObject<List<EmployeeProfileMap>>(str);
                    //Boolean flag = false;
                ...
                {
                    List<ProfileItemMap> profileItemMaps = DsfJSONConvert.DeserializeObject<List<ProfileItemMap>>(str);
                    Boolean flag = false;
                ...
                {
                    EmployeeIncentiveInfo EmployeeIncentiveInfo = DsfJSONConvert.DeserializeObject<EmployeeIncentiveInfo>(str);
                ...
                else if (reqType == "updateEmployeeBillItem")
                {
                    ...
                    try
                    {
                        EmployeeBillItemsMap employeeBillItem = DsfJSONConvert.DeserializeObject<EmployeeBillItemsMap>(str);
                ...
                else if (reqType == "updateProfileBillItemMap")
                {
                    ...
                    try
                    {
                        ProfileItemMap ProfileBillItemMap = DsfJSONConvert.DeserializeObject<ProfileItemMap>(str);
                ...
                {
                    List<ItemGroupDistribution> itmGrpDistributionsFromClient = DsfJSONConvert.DeserializeObject<List<ItemGroupDistribution>>(str);
                    using (var dbContextTxn = incentiveDb.Database.BeginTransaction())
                    {
                        try
                        {
                ...
                {
                    List<IncentiveFractionItemModel> fractionItems = DsfJSONConvert.DeserializeObject<List<IncentiveFractionItemModel>>(str);
                    if (fractionItems != null && fractionItems.Count > 0)
                    {
                        foreach (var item in fractionItems)
                        {
                ...
                {
                    PaymentInfoModel paymentInfo = DsfJSONConvert.DeserializeObject<PaymentInfoModel>(str);
                    string idsToUpdt = this.ReadQueryStringData("fractionItenIdsToUpdate");
                    List<int> allFractionIdsToUpdate = DsfJSONConvert.DeserializeObject<List<int>>(idsToUpdt);
                ...
                {
                    ProfileModel profile = DsfJSONConvert.DeserializeObject<ProfileModel>(str);
        ...
        public string Put()
        {
            ...
            try
            {
                ...
                if (reqType == "updateProfile")
                {
                    ProfileModel profileData = DsfJSONConvert.DeserializeObject<ProfileModel>(str);
