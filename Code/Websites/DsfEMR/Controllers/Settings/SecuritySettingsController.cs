...
namespace DsfEMR.Controllers
{
    ...
    public class SecuritySettingsController : CommonController
    {
        ...
        {
            RbacUser user = DsfJSONConvert.DeserializeObject<RbacUser>(ipDataStr);
        ...
        {
            {
                RbacRole role = DsfJSONConvert.DeserializeObject<RbacRole>(ipDataStr);
        ...
        private int SaveRolePermissions(int roleId, string ipDataStr)
        {
            ...
            List<RolePermissionMap> rolePermissions = DsfJSONConvert.DeserializeObject<List<RolePermissionMap>>(ipDataStr);
        ...
        {
            List<UserRoleMap> rolePermissions = DsfJSONConvert.DeserializeObject<List<UserRoleMap>>(ipDataStr);
        ...
        {
            List<UserRoleMap> userRoles = DsfJSONConvert.DeserializeObject<List<UserRoleMap>>(ipDataStr);
     ...
     return DsfJSONConvert.SerializeObject(responseData, true);*//*
        ...
        public string Post(int? roleId)
        {
            ...
            try
            {
                ...
                *//*                if (reqType == "post-security-user")
                                {
                                    RbacUser user = DsfJSONConvert.DeserializeObject<RbacUser>(str);
        ...
        /*if (reqType == "post-security-role")
        {
            RbacRole role = DsfJSONConvert.DeserializeObject<RbacRole>(str);
        ...
        if (reqType == "post-security-rolePermission")
        {
            ...
            if (roleId != null)
            {
                ...
                List<RolePermissionMap> rolePermissions = DsfJSONConvert.DeserializeObject<List<RolePermissionMap>>(str);
                rolePermissions.ForEach(roleP =>
                {
        ...
        {
            List<UserRoleMap> rolePermissions = DsfJSONConvert.DeserializeObject<List<UserRoleMap>>(str);
            rolePermissions.ForEach(userRole =>
            {
...
public string Put()
{
    ...
    try
    {
       *//* if (reqType == "put-security-user")
        ...
        /*if (reqType == "put-security-userRole")
        {
            List<UserRoleMap> userRoles = DsfJSONConvert.DeserializeObject<List<UserRoleMap>>(str);
            userRoles.ForEach(userRole =>
            {
