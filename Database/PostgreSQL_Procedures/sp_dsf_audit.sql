-- 4-parameter version
DROP FUNCTION IF EXISTS sp_dsf_audit(timestamp, timestamp, varchar, varchar) CASCADE;
CREATE OR REPLACE FUNCTION public.sp_dsf_audit(
...
DROP FUNCTION IF EXISTS sp_dsf_audit(timestamp, timestamp, varchar, varchar, varchar) CASCADE;
CREATE OR REPLACE FUNCTION public.sp_dsf_audit(
