...
using DsfEMR.Services.Discharge;
using DsfEMR.Services.Admission.DTOs;
using DsfEMR.Services.Visits.DTO;
...
namespace DsfEMR.Controllers
{
    ...
    public class AdmissionController : CommonController
    {
            ...
            {
                {
                    ...
                    SmsModel responseSms = DsfJSONConvert.DeserializeObject<SmsModel>(responseString);
            ...
            int priceCategoryId)
        {
            ...
            {
                ADTAutoAddItemParameterVM adtParameter = DsfJSONConvert.DeserializeObject<ADTAutoAddItemParameterVM>(parameter.ParameterValue);
                BillingFiscalYear fiscYear = BillingBL.GetFiscalYear(connString);
                var ProvisionalReceiptNo = BillingBL.GetProvisionalReceiptNo(connString);
                int ProvisionalFiscalYearId = fiscYear.FiscalYearId;
        ...
        {
            AdmissionModel clientAdt = DsfJSONConvert.DeserializeObject<AdmissionModel>(ipDataString);
            ...
            if (IsValidForAdmission(_admissionDbContext, clientAdt.PatientId))
            {
                ...
                if (clientAdt.AdmittingDoctorId.HasValue && clientAdt.AdmittingDoctorId > 0)
                {
                    ...
                    EmployeeModel docinfo = DsfJSONConvert.DeserializeObject<EmployeeModel>(ipDataString);
        ...
        private object AddDischargeSummary(string ipDataString)
        {
            ...
            {
                DischargeSummaryModel summary = DsfJSONConvert.DeserializeObject<DischargeSummaryModel>(ipDataString);
        ...
        {
            AdmissionModel admission = DsfJSONConvert.DeserializeObject<AdmissionModel>(ipDataString);
        ...
        {
            DischargeCancelModel cancelDisch = DsfJSONConvert.DeserializeObject<DischargeCancelModel>(ipDataString);
        ...
        {
            HemodialysisModel newHemoReport = DsfJSONConvert.DeserializeObject<HemodialysisModel>(ipDataString);
        ...
        {
            PatientCertificateModel report = DsfJSONConvert.DeserializeObject<PatientCertificateModel>(ipDataString);
        ...
        {
            ADTBedReservation reservedBed = DsfJSONConvert.DeserializeObject<ADTBedReservation>(ipDataString);
        ...
        {
            ZeroItemDischargeModel data = DsfJSONConvert.DeserializeObject<ZeroItemDischargeModel>(ipDataString);
        ...
        {
            //var transferredFrom = this.ReadQueryStringData("transferredFrom");
            PatientBedInfo newBedInfo = DsfJSONConvert.DeserializeObject<PatientBedInfo>(ipDataString);
        ...
        {
            PatientBedInfoVM clientBedInfo = DsfJSONConvert.DeserializeObject<PatientBedInfoVM>(ipDataString);
        ...
        {
            UpdateAdmittingDoctorVM admittingDoc = DsfJSONConvert.DeserializeObject<UpdateAdmittingDoctorVM>(ipDataString);
        ...
        {
            DischargeDetailVM dischargeDetail = DsfJSONConvert.DeserializeObject<DischargeDetailVM>(ipDataString);
        ...
        private object CancelAdmission(string ipDataString, RbacUser currentUser)
        {
            ...
            //BillingTransactionItemModel billingTransactionItem = DsfJSONConvert.DeserializeObject<BillingTransactionItemModel>(ipDataString);
            AdmissionCancelVM admissionCancelDetail = DsfJSONConvert.DeserializeObject<AdmissionCancelVM>(ipDataString);
        ...
        {
            ADTBedReservation bedReservationToUpdate = DsfJSONConvert.DeserializeObject<ADTBedReservation>(ipDataString);
        ...
        {
            int resIdToCancel = DsfJSONConvert.DeserializeObject<int>(ipDataString);
            using (var resTransaction = _admissionDbContext.Database.BeginTransaction())
            {
                try
                {
        ...
        {
            int patVisitId = DsfJSONConvert.DeserializeObject<int>(ipDataString);
            using (var resTransaction = _admissionDbContext.Database.BeginTransaction())
            {
                try
                {
        ...
        {
            NotesModel NotesMaster = DsfJSONConvert.DeserializeObject<NotesModel>(ipDataString);
