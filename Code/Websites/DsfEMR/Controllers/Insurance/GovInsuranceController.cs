...
using DsfEMR.ServerModel.InsuranceModels;
...
namespace DsfEMR.Controllers
{
    public class GovInsuranceController : CommonController
    {
        ...
        //        //    MasterDbContext masterDbContext = new DsfEMR.DalLayer.MasterDbContext(connString);
        ...
        public object PostInsuranceBilling()
        {
            ...
            InsuranceBillingTransactionPostVM insuranceBillingTransactionPostVM = DsfJSONConvert.DeserializeObject<InsuranceBillingTransactionPostVM>(strInsuranceBilling);
...
//            /* if (reqType == "addNewRequisitions") //comes here from doctor and nurse orders.
//             {
//                 List<LabRequisitionModel> labReqListFromClient = DsfJSONConvert.DeserializeObject<List<LabRequisitionModel>>(str);
//                 LabVendorsModel defaultVendor = insuranceDbContext.LabVendors.Where(val => val.IsDefault == true).FirstOrDefault();
...
//                            if (reqType == "Deposit")
//                            {
//                                BillingDeposit deposit = DsfJSONConvert.DeserializeObject<BillingDeposit>(ipDataString);
...
//                    List<BedDurationTxnDetailsVM> bedDurationDetails = DsfJSONConvert.DeserializeObject<List<BedDurationTxnDetailsVM>>(str);
...
//                {
//                    string str = this.ReadPostData();
//                    DischargeDetailVM dischargeDetail = DsfJSONConvert.DeserializeObject<DischargeDetailVM>(str);
...
//                {
//                    var str = this.ReadPostData();
//                    InsuranceBalanceHistoryModel insBalance = DsfJSONConvert.DeserializeObject<InsuranceBalanceHistoryModel>(str);
//                    if (insBalance != null)
//                    {
...
//        }
        ...
        private static PatientModel GetPatientModelFromPatientVM(GovInsurancePatientVM govPatientVM, string connString, InsuranceDbContext insDbContext)
        {
            ...
            NewPatientUniqueNumbersVM newPatientNumber = DsfEMR.Controllers.PatientBL.GetPatNumberNCodeForNewPatient(connString);
        ...
        {
            DsfHTTPResponse<QuickVisitVM> responseData = new DsfHTTPResponse<QuickVisitVM>();
            try
            {
                InsuranceDbContext insuranceDbContext = new InsuranceDbContext(base.connString);
                RbacUser currentUser = HttpContext.Session.Get<RbacUser>(ENUM_SessionVariables.CurrentUser);
                QuickVisitVM quickVisit = DsfJSONConvert.DeserializeObject<QuickVisitVM>(strLocal);
        ...
        private static void SyncBillToRemoteServer(object billToPost, string billType, InsuranceDbContext dbContext)
        {
            if (billType == "sales")
            {
                ...
                try
                {
                    ...
                    responseMsg = DsfEMR.Sync.IRDNepal.APIs.PostSalesBillToIRD(bill);
                }
                catch (Exception ex)
                {
                    responseMsg = "0";
            ...
            else if (billType == "sales-return")
            {
                ...
                try
                {
                    ...
                    responseMsg = DsfEMR.Sync.IRDNepal.APIs.PostSalesReturnBillToIRD(salesRetBill);
                }
                catch (Exception ex)
                {
                    responseMsg = "0";
        ...
        private QuickVisitVM PaidFollowupVisitTransaction(string strLocal)
        {
            ...
            try
            {
                InsuranceDbContext insuranceDbContext = new InsuranceDbContext(base.connString);
                RbacUser currentUser = HttpContext.Session.Get<RbacUser>(ENUM_SessionVariables.CurrentUser);
                quickVisit = DsfJSONConvert.DeserializeObject<QuickVisitVM>(strLocal);
        ...
        private object SaveBillingTransactionItems(string ipDataStr, RbacUser currentUser)
        {
            ...
            //Transaction Begins 
            List<BillingTransactionItemModel> billTranItems = DsfJSONConvert.DeserializeObject<List<BillingTransactionItemModel>>(ipDataStr);
        ...
        private object SaveNewRequisitions(string ipDataStr)
        {
            ...
            List<LabRequisitionModel> labReqListFromClient = DsfJSONConvert.DeserializeObject<List<LabRequisitionModel>>(ipDataStr);
        ...
        {
            BillingDepositModel deposit = DsfJSONConvert.DeserializeObject<BillingDepositModel>(ipDataStr);
            deposit.CreatedOn = System.DateTime.Now;
            deposit.CreatedBy = currentUser.EmployeeId;
            BillingFiscalYear fiscYear = BillingBL.GetFiscalYear(connString);
            deposit.FiscalYearId = fiscYear.FiscalYearId;
        ...
        private object SaveInsDischargeBill(String ipDataStr, RbacUser currentUser)
        {
            ...
            DateTime currentDate = DateTime.Now;
            BillingTransactionModel billTransaction = DsfJSONConvert.DeserializeObject<BillingTransactionModel>(ipDataStr);
            bool transactionSuccess = false;
            if (billTransaction != null)
            {
                //check if discharge valid or not before entering other code logic.
        ...
        {
            BillingTransactionItemModel txnItmFromClient = DsfJSONConvert.DeserializeObject<BillingTransactionItemModel>(ipDataStr);
            txnItmFromClient.ModifiedBy = currentUser.EmployeeId;
        ...
        {
            DischargeDetailVM dischargeDetail = DsfJSONConvert.DeserializeObject<DischargeDetailVM>(ipDataStr);
        ...
        {
            List<BillingTransactionItemModel> txnItemsToCancel = DsfJSONConvert.DeserializeObject<List<BillingTransactionItemModel>>(ipDataStr);
        ...
        {
            List<BillingTransactionItemModel> txnItems = DsfJSONConvert.DeserializeObject<List<BillingTransactionItemModel>>(ipDataStr);
            if (txnItems != null)
            {
                txnItems.ForEach(item =>
                {
        ...
        private object UpdateInsuranceBalance(String ipDataStr, RbacUser currentUser)
        {
            ...
            InsuranceBalanceHistoryModel insBalance = DsfJSONConvert.DeserializeObject<InsuranceBalanceHistoryModel>(ipDataStr);
            if (insBalance != null)
            {
