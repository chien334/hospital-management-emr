...
using DsfEMR.Services.Billing.DTO;
...
namespace DsfEMR.Controllers
{
    ...
    public class BillingController : CommonController
    {
        ...
        private DsfHTTPResponse<object> _objResponseData;
        ...
        public BillingController(IOptions<MyConfiguration> _config) : base(_config)
        {
            ...
            _objResponseData = new DsfHTTPResponse<object>();
            _objResponseData.Status = ENUM_Dsf_HTTP_ResponseStatus.OK;//this is for default
        }
        ...
        public IActionResult GetProviderList()
        {
            ...
            Func<object> func = () => GetProviderListFromDsfCache();
            return InvokeHttpGetFunction<object>(func);
        }
        ...
        //            //List<BillingItemVM> itemList = (List<BillingItemVM>)DsfCache.Get("billItem-srvdept-" + serviceDeptId);
        //            //if (itemList == null)
        //            //{
        ...
        //            //        DsfCache.Add("billItem-srvdept-" + serviceDeptId, itemList, DateTime.Now.AddMinutes(cacheExpMinutes));
        ...
        //            //{
        //            //    srvDeptIds = DsfJSONConvert.DeserializeObject<List<int>>(srvDeptIdListStr);
        //            //    filterBySrvDeptId = srvDeptIds.Count() > 0 ? true : false;
        //            //}
        //            //if (!string.IsNullOrWhiteSpace(itemIdListStr))
        //            //{
        //            //    itemIds = DsfJSONConvert.DeserializeObject<List<int>>(itemIdListStr);
        ...
        //            //List<EmployeeModel> empListFromCache = (List<EmployeeModel>)DsfCache.GetMasterData(MasterDataEnum.Employee);
        ...
        //    //        //List<BillingTransactionItemModel> billTranItems = DsfJSONConvert.DeserializeObject<List<BillingTransactionItemModel>>(ipDataString);
        ...
        //    //        //BillingTransactionModel billTransaction = DsfJSONConvert.DeserializeObject<BillingTransactionModel>(ipDataString);
        ...
        //    //        //List<BillItemRequisition> ItemRequests = DsfJSONConvert.DeserializeObject<List<BillItemRequisition>>(ipDataString);
        ...
        //    //    else if (reqType == "post-handover-denomination-detail")
        //    //    {
        //    //        //BillingHandoverModel handoverInfo = DsfJSONConvert.DeserializeObject<BillingHandoverModel>(ipDataString);
        ...
        //    //        //BillingHandoverTransactionModel HandovertransactionInfo = DsfJSONConvert.DeserializeObject<BillingHandoverTransactionModel>(ipDataString);
        ...
        //        if (reqType == "billItemReqsStatus")
        //        {
        //            //List<Int32> billItemReqIds = DsfJSONConvert.DeserializeObject<List<Int32>>(str);
        ...
        //        else if (reqType == "UpdateBillStatusForCreditCancellation")
        //        {
        //            // List<Int32> BillTransactionItemIds = DsfJSONConvert.DeserializeObject<List<Int32>>(str);
        //            //int? currTxnItmId = DsfJSONConvert.DeserializeObject<int?>(str);
        ...
        //            // List<Int32> BillTransactionItemIds = DsfJSONConvert.DeserializeObject<List<Int32>>(str);
        //            //List<BillingTransactionItemModel> txnItemsToCancel = DsfJSONConvert.DeserializeObject<List<BillingTransactionItemModel>>(str);
        ...
        //        else if (reqType == "UpdateDoctorafterDoctorEdit")
        //        {
        //            //int BillTxnItemId = DsfJSONConvert.DeserializeObject<int>(str);

        //            //var PerformerObj = DsfJSONConvert.DeserializeObject<EmployeeBasicDetail>(Performer);
        //            //var PrescriberObj = DsfJSONConvert.DeserializeObject<EmployeeBasicDetail>(Prescriber);
        ...
        //            //BillingTransactionItemModel txnItmFromClient = DsfJSONConvert.DeserializeObject<BillingTransactionItemModel>(str);
        ...
        //        else if (reqType == "cancelInpatientItemFromWard")
        //        {
        //            //BillingTransactionItemModel inpatientTest = DsfJSONConvert.DeserializeObject<BillingTransactionItemModel>(str);
        //            //List<SqlParameter> paramList = new List<SqlParameter>(){
        ...
        //        else if (reqType == "item-group-discount")
        //        {
        //            //List<BillingTransactionItemModel> txnItems = DsfJSONConvert.DeserializeObject<List<BillingTransactionItemModel>>(str);
        ...
        //        else if (reqType == "update-handover-transaction-detail")
        //        {
        //            //BillingHandoverTransactionModel handoverTxnFromClient = DsfJSONConvert.DeserializeObject<BillingHandoverTransactionModel>(str);
        ...
        {
            List<BillingItemVM> itemList = (List<BillingItemVM>)DsfCache.Get("billItem-srvdept-" + serviceDepartmentId);
            if (itemList == null)
            {
                ...
                if (serviceDept.BillItemPriceList.Count != 0)
                {
                    ...
                    DsfCache.Add("billItem-srvdept-" + serviceDepartmentId, itemList, DateTime.Now.AddMinutes(cacheExpMinutes));
...
/*            List<string> excludedServicedeptNames = new List<string>() { "OPD", "EMERGENCY" };*/
        ...
        private object GetProviderListFromDsfCache()
        {
            List<EmployeeModel> empListFromCache = (List<EmployeeModel>)DsfCache.GetMasterData(MasterDataEnum.Employee);
            var docotorList = empListFromCache.Where(emp => emp.IsAppointmentApplicable.HasValue
                                                  && emp.IsAppointmentApplicable == true).ToList()
        ...
        {
            List<Int32> billItemReqIds = DsfJSONConvert.DeserializeObject<List<Int32>>(ipDataString);
            BillItemRequisition billItem = new BillItemRequisition();
            foreach (var id in billItemReqIds)
            {
        ...
        private int? PutBillStatusForCreditCancellation(string ipDataString, string status, string remarks, int CreatedBy)
        {
            ...
            int? currTxnItmId = DsfJSONConvert.DeserializeObject<int?>(ipDataString);
        ...
        {
            List<BillingTransactionItemModel> txnItemsToCancel = DsfJSONConvert.DeserializeObject<List<BillingTransactionItemModel>>(ipDataString);
        ...
        {
            int BillTxnItemId = DsfJSONConvert.DeserializeObject<int>(ipDataString);
        ...
        private object CancelOutpatientProvisionalItem(string ipDataString, RbacUser currentUser, BillingDbContext _billingDbContext)
        {
            ...
            using (var dbTransaction = _billingDbContext.Database.BeginTransaction())
            {
                try
                {
                    ...
                    BillingTransactionItemModel txnItmFromClient = DsfJSONConvert.DeserializeObject<BillingTransactionItemModel>(ipDataString);
        ...
        private DataTable CancelIpItemFromWard(string ipDataString, RbacUser currentUser)
        {
            ...
            BillingTransactionItemModel inpatientTest = DsfJSONConvert.DeserializeObject<BillingTransactionItemModel>(ipDataString);
            List<SqlParameter> paramList = new List<SqlParameter>(){
                                                    new SqlParameter("@BillingTransactionItemId", inpatientTest.BillingTransactionItemId),
                                                    new SqlParameter("@RequisitionId", (inpatientTest.RequisitionId.HasValue? inpatientTest.RequisitionId : 0)),
                                                    new SqlParameter("@IntegrationName", inpatientTest.ItemIntegrationName),
        ...
        //{
        //    List<BillingTransactionItemModel> txnItems = DsfJSONConvert.DeserializeObject<List<BillingTransactionItemModel>>(ipDataString);
        //    txnItems.ForEach(item =>
        //    {
        ...
        {
            BillingHandoverTransactionModel handoverTxnFromClient = DsfJSONConvert.DeserializeObject<BillingHandoverTransactionModel>(ipDataString);
        ...
        {
            BillingTransactionPostVM billingTransactionPostVM = DsfJSONConvert.DeserializeObject<BillingTransactionPostVM>(strBillingTransactionData);
            BillingTransactionModel billingTransactionModel = new BillingTransactionModel();
