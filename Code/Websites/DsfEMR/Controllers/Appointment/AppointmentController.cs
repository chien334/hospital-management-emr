...
namespace DsfEMR.Controllers
{
    ...
    public class AppointmentController : CommonController
    {
        ...
        //        //else
        //        //{
        //        AppointmentModel ipApptModel = DsfJSONConvert.DeserializeObject<AppointmentModel>(str);
        ...
        //        {
        //            //AppointmentDbContext dbContextUpdate = new AppointmentDbContext(connString);
        //            //AppointmentModel updatedAppointment = DsfJSONConvert.DeserializeObject<AppointmentModel>(str);
        ...
        //        {
        //            //AppointmentDbContext dbContextUpdate = new AppointmentDbContext(connString);
        //            //AppointmentModel appointmentData = DsfJSONConvert.DeserializeObject<AppointmentModel>(str);
        ...
        //{
        //    DsfHTTPResponse<QuickAppointmentVM> responseData = new DsfHTTPResponse<QuickAppointmentVM>();

        //    try
        //    {
        //        string str = Request.Form.Keys.First<string>();
        //        QuickAppointmentVM ipQckApptModel = DsfJSONConvert.DeserializeObject<QuickAppointmentVM>(str);
