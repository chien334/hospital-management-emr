...
using DsfEMR.Services.Verification.DTOs.Pharmacy;
using DsfEMR.Services.WardSupply.Pharmacy.Requisiton;
using DsfEMR.Utilities;
using DsfEMR.ViewModel.Substore;
...
namespace DsfEMR.Controllers
{
    ...
    public class WardSupplyController : CommonController
    {
        ...
        [HttpGet("Departments")]
        [Produces(typeof(DsfHTTPResponse<List<DepartmentModel>>))]
        ...
        [HttpGet("Wards")]
        [Produces(typeof(DsfHTTPResponse<List<WardModel>>))]
        ...
        [Produces(typeof(DsfHTTPResponse<List<PHRMStoreModel>>))]
        ...
        [Produces(typeof(DsfHTTPResponse<List<WardSupplyRequisitionsDTO>>))]
        ...
        [Produces(typeof(DsfHTTPResponse<List<WardSupplyInternalConsumptionListDTO>>))]
        ...
        [Produces(typeof(DsfHTTPResponse<List<WardSupplyInternalConsumptionItemListDTO>>))]
        ...
        [Produces(typeof(DsfHTTPResponse<List<WardSupplyRequisitionItemsByIdDTO>>))]
        ...
        [Produces(typeof(DsfHTTPResponse<List<WardSupplyPatientConsumptionItemDTO>>))]
        ...
        [Produces(typeof(DsfHTTPResponse<List<WardSupplyInventoryConsumptionItemListDTO>>))]
        ...
        /// <param name="StoreId">StoreId of the current active store.</param>
        [HttpGet("WardStock")]
        [Produces(typeof(DsfHTTPResponse<List<WardSupplyWardStockDTO>>))]
        public IActionResult GetWardStock(int StoreId)
        {
            ...
            //         responseData.Status = (totalStock == null) ? ENUM_DsfHttpResponseText.Failed : ENUM_DsfHttpResponseText.OK;
        ...
        [Produces(typeof(DsfHTTPResponse<List<WardSupplyInPatientListDTO>>))]
        ...
        private static List<RequisitionModel> GetSubStoreRequisitions(DateTime FromDate, DateTime ToDate, int StoreId, RbacUser user, InventoryDbContext inventoryDbContext)
        {
            ...
            foreach (var Requisition in RequisitionList)
            {
                ...
                {
                    VerifierList = DsfJSONConvert.DeserializeObject<List<dynamic>>(Requisition.VerifierIds);
                }
        ...
        public IActionResult PostInventoryConsumption()
        {
            ...
            var consumptionItems = DsfJSONConvert.DeserializeObject<List<WARDInventoryConsumptionModel>>(ipDataStr);
        ...
        public IActionResult PostInternalConsumption()
        {
            ...
            string ipDataStr = this.ReadPostData();
            var wardInternalconsumption = DsfJSONConvert.DeserializeObject<WARDInternalConsumptionModel>(ipDataStr);
        ...
        public IActionResult PostTransferInventoryStock()
        {
            ...
            //{
            //    WARDStockModel stockManageData = DsfJSONConvert.DeserializeObject<WARDStockModel>(str);
        ...
        public string WardInventoryReturn()
        {
            ...
            RbacUser currentUser = HttpContext.Session.Get<RbacUser>(ENUM_SessionVariables.CurrentUser);
            string Str = this.ReadPostData();
            //WARDInventoryReturnModel ReturnFromClient = DsfJSONConvert.DeserializeObject<WARDInventoryReturnModel>(Str);
            WARDInventoryReturnModel ReturnFromClient = DsfJSONConvert.DeserializeObject<WARDInventoryReturnModel>(Str);
        ...
        {
            RequisitionModel requisition = JsonConvert.DeserializeObject<RequisitionModel>(DsfJSONConvert.SerializeObject(requisitionDTO));
            RbacUser currentUser = HttpContext.Session.Get<RbacUser>(ENUM_SessionVariables.CurrentUser);
            DsfHTTPResponse<object> responseData = new DsfHTTPResponse<object>();
        ...
        {
            string Str = this.ReadPostData();
            List<SubstoreStockViewModel> stock = DsfJSONConvert.DeserializeObject<List<SubstoreStockViewModel>>(Str);
        ...
        public IActionResult Post([FromBody] PharmacySubStoreRequisition_DTO requisitionDTO)
        {
            ...
            try
            {
                ...
                if (requisitionDTO != null)
                {
                    ...
                    PHRMStoreRequisitionModel requisition = DsfJSONConvert.DeserializeObject<PHRMStoreRequisitionModel>(DsfJSONConvert.SerializeObject(requisitionDTO));
                    requisition.VerifierIds = SerializeVerifiers(requisitionDTO.VerifierList);
