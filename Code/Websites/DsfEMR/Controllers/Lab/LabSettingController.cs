...
namespace DsfEMR.Controllers
{
    public class LabSettingController : CommonController
    {
        ...
        {
            LabReportTemplateModel labReportTemplate = DsfJSONConvert.DeserializeObject<LabReportTemplateModel>(ipDataString);
        ...
        private object AddLabTestMaster(string ipDataString, RbacUser currentUser)
        {
            using (var dbContextTransaction = _labDbContext.Database.BeginTransaction())
            {
                try
                {
                    LabTestModel labTest = DsfJSONConvert.DeserializeObject<LabTestModel>(ipDataString);
        ...
        {
            List<LabTestJSONComponentModel> componentList = DsfJSONConvert.DeserializeObject<List<LabTestJSONComponentModel>>(ipDataString);
            using (var dbContextTransaction = _labDbContext.Database.BeginTransaction())
            {
                try
                {
        ...
        {
            CoreCFGLookupModel Lookup = DsfJSONConvert.DeserializeObject<CoreCFGLookupModel>(ipDataString);
            using (var dbContextTransaction = _labDbContext.Database.BeginTransaction())
            {
                try
                {
        ...
        {
            LabVendorsModel vendorFromClient = DsfJSONConvert.DeserializeObject<LabVendorsModel>(ipDataString);
        ...
        private object AddLabCategoryMaster(string ipDataString, RbacUser currentUser, RbacDbContext _rbacDbContext)
        {
            ...
            LabTestCategoryModel categoryFromClient = DsfJSONConvert.DeserializeObject<LabTestCategoryModel>(ipDataString);
        ...
        {
            LabGovReportMappingModel item = DsfJSONConvert.DeserializeObject<LabGovReportMappingModel>(ipDataString);
            if (item != null)
            {
        ...
        {
            List<AdminParametersModel> AllSignatories = DsfJSONConvert.DeserializeObject<List<AdminParametersModel>>(ipDataString);
        ...
        private object UpdateGovReportMapping(string ipDataString)
        {
            ...
            LabGovReportMappingModel component = DsfJSONConvert.DeserializeObject<LabGovReportMappingModel>(ipDataString);
        ...
        private object UpdateLabTestActiveStatus(string ipDataString)
        {
            ...
            LabTestModel test = DsfJSONConvert.DeserializeObject<LabTestModel>(ipDataString);
        ...
        private object UpdateLabCategoryActiveStatus(string ipDataString, RbacDbContext rbacDbContext)
        {
            ...
            LabTestCategoryModel categoryModelFromClient = DsfJSONConvert.DeserializeObject<LabTestCategoryModel>(ipDataString);
        ...
        {
            LabReportTemplateModel report = DsfJSONConvert.DeserializeObject<LabReportTemplateModel>(ipDataString);
        ...
        {
            //if (reqType == "put-lab-vendor-isactive")
            LabVendorsModel vendor = DsfJSONConvert.DeserializeObject<LabVendorsModel>(ipDataString);
