...
import { ENUM_DsfHTTPResponses, ENUM_MessageBox_Status, ENUM_PharmacyRequisitionVerificationStatus } from "../../../shared/shared-enums";
...
export class PharmacyVerificationRequisitionListComponent {
    ...
    GetPharmacyRequisitionsBasedOnUser(fromDate: string, toDate: string) {
        this.verificationBLService.GetPharmacyRequisitionsBasedOnUser(fromDate, toDate).subscribe((res: DsfHTTPResponse) => {
