...
namespace DsfEMR.Controllers
{
    ...
    public class RadiologySettingsController : CommonController
    {
        ...
        {
            RadiologyImagingItemModel radImgItem = DsfJSONConvert.DeserializeObject<RadiologyImagingItemModel>(ipDataStr);
        ...
        {
            RadiologyImagingTypeModel radImgType = DsfJSONConvert.DeserializeObject<RadiologyImagingTypeModel>(ipDataStr);
        ...
        {
                RadiologyReportTemplateModel clientRadRptTemplateData = DsfJSONConvert.DeserializeObject<RadiologyReportTemplateModel>(ipDataStr);
        ...
        private object UpdateImagingItem(string ipDataStr)
        {
            ...
            RadiologyImagingItemModel clientImgItem = DsfJSONConvert.DeserializeObject<RadiologyImagingItemModel>(ipDataStr);
        ...
        {
            RadiologyImagingTypeModel clientImgType = DsfJSONConvert.DeserializeObject<RadiologyImagingTypeModel>(ipDataStr);
        ...
        public string Post()
        {
            ...
            try
            {
                ...
                if (reqType == "post-rad-imaging-item")
                {
                    RadiologyImagingItemModel radImgItem = DsfJSONConvert.DeserializeObject<RadiologyImagingItemModel>(str);
                    radImgItem.CreatedOn = DateTime.Now;
                    radImgItem.CreatedBy = currentUser.EmployeeId;
                ...
                {
                    RadiologyImagingTypeModel radImgType = DsfJSONConvert.DeserializeObject<RadiologyImagingTypeModel>(str);
                    radImgType.CreatedOn = DateTime.Now;
                ...
                {
                    RadiologyReportTemplateModel clientRadRptTemplateData = DsfJSONConvert.DeserializeObject<RadiologyReportTemplateModel>(str);
        ...
        public string Put()
        {
            ...
            try
            {
                if (reqType == "put-rad-imaging-type")
                {
                    ...
                    RadiologyImagingTypeModel clientImgType = DsfJSONConvert.DeserializeObject<RadiologyImagingTypeModel>(str);
                ...
                {
                    //First update radiology item. then billing item.
                    RadiologyImagingItemModel clientImgItem = DsfJSONConvert.DeserializeObject<RadiologyImagingItemModel>(str);
