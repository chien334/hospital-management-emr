    ...
    public class PharmacySettingsController : CommonController
    {
        ...
        private object AddSupplier(string ipDataString, RbacUser currentUser)
        {
            using (var dbTxn = _pharmacyDbContext.Database.BeginTransaction())
            {
                try
                {
                    PHRMSupplierModel supplierData = DsfJSONConvert.DeserializeObject<PHRMSupplierModel>(ipDataString);
        ...
        {
            PHRMCompanyModel companyData = DsfJSONConvert.DeserializeObject<PHRMCompanyModel>(ipDataString);
        ...
        {
            PHRMStoreModel dispensaryData = DsfJSONConvert.DeserializeObject<PHRMStoreModel>(ipDataString);
        ...
        {
            PHRMStoreSalesCategoryModel salescategoryData = DsfJSONConvert.DeserializeObject<PHRMStoreSalesCategoryModel>(ipDataString);
        ...
        {
            PHRMCategoryModel categoryData = DsfJSONConvert.DeserializeObject<PHRMCategoryModel>(ipDataString);
        ...
        {
            PHRMItemMasterModel itemData = DsfJSONConvert.DeserializeObject<PHRMItemMasterModel>(ipDataString);
        ...
        {
            PHRMTAXModel taxData = DsfJSONConvert.DeserializeObject<PHRMTAXModel>(ipDataString);
        ...
        {
            PHRMGenericModel genericData = DsfJSONConvert.DeserializeObject<PHRMGenericModel>(ipDataString);
        ...
        {
            PHRMUnitOfMeasurementModel uomData = DsfJSONConvert.DeserializeObject<PHRMUnitOfMeasurementModel>(ipDataString);
        ...
        {
            PHRMItemTypeModel itemtypeData = DsfJSONConvert.DeserializeObject<PHRMItemTypeModel>(ipDataString);
        ...
        {
            PHRMPackingTypeModel packingtypeData = DsfJSONConvert.DeserializeObject<PHRMPackingTypeModel>(ipDataString);
        ...
        {
            PHRMCreditOrganizationsModel org = DsfJSONConvert.DeserializeObject<PHRMCreditOrganizationsModel>(ipDataString);
        ...
        {
            PHRMCreditOrganizationsModel creditOrganization = DsfJSONConvert.DeserializeObject<PHRMCreditOrganizationsModel>(ipDataString);
        ...
        {
            CfgParameterModel parameter = DsfJSONConvert.DeserializeObject<CfgParameterModel>(ipDataString);
