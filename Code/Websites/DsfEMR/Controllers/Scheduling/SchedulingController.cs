...
using DsfEMR.ServerModel.SchedulingModels;
    ...
    public class SchedulingController : CommonController
    {
        ...
        public string Post()
        {
            ...
            try
            {
                ...
                {
                    List<EmpSchedules> schedulesData = DsfJSONConvert.DeserializeObject<List<EmpSchedules>>(str);
                ...
                {
                    ShiftsMasterModel shiftMaster = DsfJSONConvert.DeserializeObject<ShiftsMasterModel>(str);
                ...
                {
                    WorkingHoursTxnVM workHrsTxnData = DsfJSONConvert.DeserializeObject<WorkingHoursTxnVM>(str);
        ...
        public string Put()
        {
            ...
            try
            {
                ...
                {
                    ShiftsMasterModel shiftData = DsfJSONConvert.DeserializeObject<ShiftsMasterModel>(str);
