CREATE OR REPLACE FUNCTION sp_acc_post_bil_getsettlementtransactions(
    ...
    */
    ...
    from (
    	select 
    		...
    		,'Credit Invoices Settled On ' || (cast(settlement.createdon as date))::varchar AS "Description"
