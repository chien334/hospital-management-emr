...
export default class GridColumnSettings {
  ...
  //     width: 250,
  //     template:
  //       `<a dsf-grid-action="addresult" class="grid-action">
  //                   Add Result
  //                </a>
  //                <a dsf-grid-action="labsticker" class="grid-action"><i class="glyphicon glyphicon-print"></i> Sticker</a>
  //                <a dsf-grid-action="undo" class="grid-action">Undo</a>
  //               `
  //   }
  ...
  static GetPatientActions() {
    ...
    template += `<a dsf-grid-action="showHistory" class="grid-action">History</a>
    ...
    if (GridColumnSettings.securityService.HasPermission("patient-pat-sticker-button")) {
      template += `<li><a dsf-grid-action="showPatientSticker" >Patient Sticker</a></li>`;
    }
    +`</ul>
    </div>`;
    ...
    // ) {
    //     template = (GridColumnSettings.securityService.HasPermission("patient-pat-sticker-button") == true) ? template + `<a dsf-grid-action="edit" class="grid-action">Edit</a>
    ...
    //           <li><a dsf-grid-action="showNeighbourCard" >Visitor Card</a></li>
    //           <li>
    //           <a dsf-grid-action="showPatientSticker" >Patient Sticker</a>
    //           </li>
    //         </ul>
    //        </div>` : template +  `<a dsf-grid-action="showHistory" class="grid-action">History</a>
    //        <div class="dropdown" style="display:inline-block;">
    //         <button class="dropdown-toggle grid-btnCstm" type="button" data-toggle="dropdown">...
    //         <span class="caret"></span></button>
    //         <ul class="dropdown-menu grid-ddlCstm">
  ...
  //< a dsf-grid - action="deposit" class="grid-action color-red " >
  //Deposit
  //< /a>
  ...
  //        width: 400,
  //        template:
  //            //   `<a dsf-grid-action="discharge" class="grid-action">
  //            //  Discharge
  //            //</a>
  //            `<a dsf-grid-action="transfer" class="grid-action">
  //           Transfer
  //         </a>
  ...
  //              <span class="caret"></span></button>
  //                <ul class="dropdown-menu grid-ddlCstm">
  //                    <li><a dsf-grid-action="upgrade">Change Bed Feature</a></li>
  //                    <li><a dsf-grid-action="billdetail">Bill Details</a></li>

  //                    <li><a dsf-grid-action="generic-sticker" title="Generic Sticker"><i class="glyphicon glyphicon-print"></i>&nbsp;Patient Generic Sticker</a></li>
  //                    <li><a dsf-grid-action="cancel">Cancel</a> </li>
  //                     <li><a dsf-grid-action="ip-wrist-band" title="WristBand"><i class="glyphicon glyphicon-print"></i>&nbsp;Wrist-Band</a></li>
  //                </ul>
  //            </div>`
  //    }
  //]
  ...
  static BillingSearchActionsRenderer(params) {
    ...
    //                </button>
    //             <ul class="dropdown-menu grid-ddlCstm">
    //               <li><a dsf-grid-action="insurance-billing" class="grid-action">
  ...
  static BillPendingOrderSearch = [
...

    {
      ...
      field: "",
      width: 200,
      template: `<a dsf-grid-action="payOne" class="grid-action">
                Pay Request
             </a>
             <a dsf-grid-action="payAll" class="grid-action">
                Pay All
             </a>`,
    },
  ];
  ...
  static BillCreditBillSearch = [
    ...
    { headerName: "Total", field: "TotalCredit", width: 110, pinned: true },
    {
      ...
      pinned: true,
      width: 200,
      template: `<a dsf-grid-action="showDetails" class="grid-action">
                Show Details
             </a>`
    },
    //<a dsf-grid-action="view" class="grid-action">Print< /a>
  ];
  ...
  static IPBillItemGridCol = [
    ...
    { headerName: "Performer", field: "PerformerName", width: 100 },
    {
      ...
      field: "",
      width: 70,
      template: `<a dsf-grid-action="edit" class="grid-action fa fa-pencil" title="click to edit this item">
               Edit
             </a>
          `,
    },
  ...
  static settlementAction(params) {
    if (params.data.DepositBalance > 0 || params.data.BilStatus == "unpaid") {
      let template = `<a dsf-grid-action="showDetails" class="grid-action">
                    ...
                    <a dsf-grid-action="print" class="grid-action">
                    Print
                    </a>
                    `;
      return template;
  ...
  static CreditCancelSearch = [
    ...
    { headerName: "Total", field: "TotalCredit", width: 110 },
    {
      ...
      field: "",
      width: 200,
      template: `<a dsf-grid-action="showCreditDetails" class="grid-action">
                Show Details
             </a>`,
    },
  ];
  ...
  static parseTemplateForRADReportList(params) {
    ...
    if (params.data.IsScanned && !(params.data.IsReportSaved)) {
      let template = `<a dsf-grid-action="show-add-report" class="grid-action">
                Add Report
             </a>
            `;
      return template;
    } else if (params.data.IsScanned && params.data.IsReportSaved) {
      let template = `<a dsf-grid-action="show-edit-report" class="grid-action">
      Edit Report
   </a>
  `;
      return template;
      ...
      let template = `<a dsf-grid-action="scan-done" class="grid-action">
                Scan Done
             </a>
           `;
      return template;
    ...
    //`<a dsf-grid-action="upload-imging-files" class="grid-action">
    //        Attach Files
    //     </a>`
  ...
  static ItemwiseRequisitionList = [
    ...
    { headerName: "Available Qty", field: "AvailableQuantity", width: 150 },
    {
      ...
      field: "",
      width: 120,
      template: `<a dsf-grid-action="itemDispatch" class="grid-action">
                Dispatch Item
             </a>`,
    },
  ];
  ...
  static INV_STK_ActionRenderer(params) {
    if (params.data.AvailQuantity >= 0) {
      var template = `<a dsf-grid-action="view" class="grid-action">View</a>`;
      if (params.data.canUserManageStock)
        template += `<a dsf-grid-action="manageStock" class="grid-action">Manage Stock</a >`;
    }
    return template;
  }
  static StockDetails = [
  ...
  static POlistVendorwise = [
    ...
    },
    {
      ...
      field: "",
      width: 200,
      template: `<a dsf-grid-action="genGR" class="grid-action">Add Goods Receipt</a>`,
    },
  ];
  static POList = [
  ...
  static PHRMStoreRequisitionActionRenderer(params) {
    ...
    if (params.data.CanApproveTransfer == true) {
      template += `<a dsf-grid-action="approveTransfer" class="grid-action animated-btn blinking-btn-warning" title="Approve Dispensary to Dispensary Transfer">
                  Approve Transfer
                  </a>`;
    }
    if (
      ...
      template += `<a dsf-grid-action="requisitionDispatch" class="grid-action">
      Dispatch Requisition
      </a>`;
    }
    if (["partial", "complete"].includes(params.data.RequisitionStatus)) {
      template += `<a dsf-grid-action="dispatchList" class="grid-action">
                  Dispatch List
                </a>`;
    }
    template += `<a dsf-grid-action="view" class="grid-action">
  ...
  static AppointmentPatientSearch = [
...

    {
      ...
      width: 180,
      template: `
             <a dsf-grid-action="appoint" class="grid-action">
                Check In
             </a>`,
    },
  ];
  ...
  static AppointmentAllPatientSearch = [
...

    {
      ...
      width: 180,
      template: `
             <a dsf-grid-action="create" class="grid-action">
                Create Appointment
             </a>`,
    },
  ];
  ...
  public static ManageUsesActionTemplate(params) {
    ...
    if (params.data.IsActive == true) {
      ...
      template = `<a dsf-grid-action="activateDeactivateBasedOnStatus" class="grid-action">
              Deactivate
            </a>
  ...
  public static ManageFractionTemplate(params) {
    ...
    if (params.data.BillTxnItemId) {
      template = `<a dsf-grid-action="view">
             View Fraction
            </a>`;
    } else {
      template = `<a dsf-grid-action="add">
                Add Fraction
               </a>`;
    }
    return template;
  ...
  public static ManageUserActionLedgerTemplate(params) {
    if (params.data.IsActive == true) {
      let template = `
            <a dsf-grid-action="activateDeactivateBasedOnStatus" class="grid-action">Deactivate</a>
            <a dsf-grid-action="edit" class="grid-action">Edit</a >
            `;
      return template;
    } else {
      let template = `
            <a dsf-grid-action="activateDeactivateBasedOnStatus" class="grid-action">Activate</a>
            `;
      return template;
    }
  }
  ...
  public static ManageFiscalYearActionTemplate(params) {
    if (params.data.IsActive == true) {
      let template = `
            <a dsf-grid-action="endFiscalYear" class="grid-action">
              End Year
            </a>`;
      return template;
    } else {
  ...
  public static ManageLedgerGrpVouchersTemplate(params) {
    if (params.data.IsActive == true) {
      let template = `
            <a dsf-grid-action="ManageLedgerGrpVouchers" class="grid-action">
              Manage Vouchers
            </a>

            <a dsf-grid-action="activateDeactivateBasedOnStatus" class="grid-action">
              Deactivate
            </a>`;
      return template;
    } else {
      let template = `<a dsf-grid-action="activateDeactivateBasedOnStatus" class="grid-action">
                Activate
               </a>`;
      return template;
    }
  ...
  public static ManageTransferRules(params) {
    if (params.data.IsActive == true) {
      let template = `
            <a dsf-grid-action="ActivateDeactivateTransferRules" class="grid-action">Deactivate</a>
            `;
      return template;
    } else {
      let template = `
            <a dsf-grid-action="ActivateDeactivateTransferRules" class="grid-action">Activate</a>
            `;
      return template;
    }
  }
  ...
  static NurOPDList = [
    ...
    { headerName: "Doctor Name", field: "ProviderName", width: 160 },
    {
      ...
      template: `<i dsf-grid-action="patient-overview" class="fa fa-tv grid-action" style="padding: 3px;" title= "overview"></i>
              <a dsf-grid-action="clinical" class="grid-action">
                Clinical
             </a>
                <i dsf-grid-action="upload-files" class="fa fa-upload grid-action" style="padding: 3px;" title="upload files"></i>`,
    },
  ];
  ...
  static NurNEPHList = [
    ...
    { headerName: "Performer Name", field: "PerformerName", width: 160 },
    {
      ...
      width: 160,
      template: `
              <a dsf-grid-action="add-report" class="grid-action">
                  Add Report
              </a>
              <a dsf-grid-action="show-report" class="grid-action">
                Show Report
             </a>`,
    },
  ];
  ...
  static WorkingHoursList = [
    ...
    { headerName: "Total Working Hrs", field: "TotalWorkingHrs", width: 100 },
    {
      ...
      field: "",
      width: 200,
      template: `<a dsf-grid-action="edit" class="grid-action">Edit Working Hours</a>`,
    },
  ];
  //  END: SCHEDULING
  ...
  static IpBillPatientSearch = [
    ...
    },
    {
      ...
      field: "",
      width: 120,
      template: `<a dsf-grid-action="view-summary" class="grid-action">
                        <i class="fa fa-eye"></i>View Details
                 </a>`,
    },
  ];
  ...
  static DoctorDepartmentAppointmentList = [
    ...
    { headerName: "Current Doctor", field: "ProviderName", width: 180 },
    {
      ...
      field: "",
      width: 150,
      template: `<a dsf-grid-action="AssignToMe" class="grid-action">Assign to me</a>`,
    },
  ];
  ...
  static ShowActionForInventoryRequisitionList(params) {
    ...
    template += `
      <div class="dropdown" style="display:inline-block;">
        ...
        <ul class="dropdown-menu grid-ddlCstm">
          <li>
            <a dsf-grid-action="CreateCopy" >Create copy</a>
          </li>
        </ul>
      </div> `;
    return template;
    ...
    if (params.data.Status == "active" || params.data.Status == "partial") {
      let template = `<a dsf-grid-action="View" class="grid-action">RFQ Details</a>
             <a dsf-grid-action="AttachQuotationDocuments" class="grid-action">Attach Quo Files</a>
                 ...
                 <span class="caret"></span></button>
                 <ul class="dropdown-menu grid-ddlCstm">
                     <li><a dsf-grid-action="AddQuotationDetails" class="grid-action">Add Vendor Quot.</a></li>
 ...
 <a dsf-grid-action="SelectedQuotation" class="grid-action"> Selected Quotation </a>`;
  ...
  static GetApptActions(params) {
    ...
    //     <a dsf-grid-action="details" class="grid-action" data-placement="top" data-toggle="tooltip" title="

    //     Created By: ${CreatedBy}
    // Modified By: ${ModifiedBy}
    // Cancelled By: ${CancelledBy}"> Details
    //        </a>
    // <a dsf-grid-action="checkin" class="grid-action">
    // CheckIn </a>
    if (
      ...
      <a dsf-grid-action="checkin" class="grid-action">
          CheckIn </a>
            <a dsf-grid-action="cancel" class="grid-action">
                Cancel</a>
            <a dsf-grid-action="edit" class="grid-action">
                Edit
                </a>
  ...
  static GetActiveFiscalYear(params) {
    if (
      ...
      return `<a dsf-grid-action="edit" class="grid-action"> Re-Open </a>`;
    }
  }
  ...
  static ImagingReportViewActionRenderer(params): string {
    // let retValue = '<a dsf-grid-action="view-report"  class="icon-' + params.data.ImagingTypeName + '"';//sud:31May'19--use this line later if required.
    let retValue = '<a dsf-grid-action="view-report"  class="grid-action"';
    retValue +=
...
<a  dsf-grid-action="genReceipt" class="grid-action">
  ...
  static VisitActionsRenderer(params) {
    ...
    if (currVisit.VisitType != "emergency") {
      ...
      if (dateDiff <= maxInternalReferralDays && !currVisit.IsFreeVisit) {
        ...
        //   templateHtml += `<a dsf-grid-action="transfer" class="grid-action">
        //                        transfer </a>`;
        // }

        templateHtml += `<a dsf-grid-action="referral" class="grid-action">
                               refer </a>`;
      }
    ...
    //templateHtml += `<a dsf-grid-action="generic-sticker" title="Generic Sticker" class="grid-action">
  ...
  static FavoritePatientRenderer(params) {
    ...
    //by default: print sticker wil be there in the action.
    let templateHtml = `<a dsf-grid-action="preview" class="d-icon icon-user" title="Preview" style="display: inherit; float:left;"></a>
             <a dsf-grid-action="notes" class="d-icon icon-note hidden" title="Notes""></a>
             <a dsf-grid-action="medication" class="d-icon icon-medication hidden" title="Medication""></a>
             <a dsf-grid-action="labs" class="d-icon icon-lab" title="Labs""></a>
             <a dsf-grid-action="imaging" class="d-icon icon-imaging" title="Imaging""></a>`;
    if (currPatient.IsFollowUp) {
      templateHtml +=
        '<a dsf-grid-action="removefollowup" class=" d-icon fa fa-file-text" style="font-size:15px;position:relative;top:-5px; margin-left:10px; margin-right:10px;;" title="remove follow up""></a>';
    } else {
      templateHtml +=
        '<a dsf-grid-action="addfollowup" class="d-icon fa fa-file-text-o" style="font-size:15px;position:relative;top:-5px; margin-left:10px; margin-right:10px;" title="add follow up""></a>';
    }

    if (currPatient.IsFavorite) {
      templateHtml +=
        '<a dsf-grid-action="removefavorite" class="fa fa-heart" style="font-size:17px;position:relative;top:-3px" title="remove favorite""></a>';
    } else {
      templateHtml +=
        '<a dsf-grid-action="addfavorite" class="fa fa-heart-o" style="font-size:17px;position:relative;top:-3px" title="add favorite""></a>';
    }
  ...
  //     <span class="caret"></span></button>
  //     <ul class="dropdown-menu grid-ddlCstm">
  //           <li><a dsf-grid-action="generic-sticker" title="Generic Sticker">
  ...
  static AccDailyTxnActionTemplate(params) {
    ...
    if (params.data.showOptions) {
      if (params.data.SectionId != 4) {
        template = `<a dsf-grid-action="viewDetails" class="grid-action"> <i class="fa fa-eye"></i>View Details</a>`;
      }
    }
    return template;
  }
...
Department:` +
  ...
  static InvoiceHeaderList = [
    ...
    { headerName: "Is Active", field: "IsActive" },
    {
      ...
      width: 200,
      template: `<a dsf-grid-action="view-logo" class="grid-action">
                  View Logo
               </a>
                  <a dsf-grid-action="edit" class="grid-action">
                  Edit
  ...
  static PatientListActionTemplate(params) {
    if (!params.data.IsActive) {
      ...
      template += `<a dsf-grid-action="activateDeactivatePatient" class="grid-action"  style="background-color: #afb8af;color: black;">
              Activate
             </a>`;
      return template;
    } else {
      ...
      template += `<a dsf-grid-action="activateDeactivatePatient" class="grid-action"  style="background-color: orange;color: black;">
             Deactivate
           </a>`;
      return template;
    }
  ...
  static AssetsFixedStockList = [
    ...
    },
    {
      ...
      //    Edit
      //  </a>
      //  <a dsf-grid-action="contract" class="grid-action">
      //               View Contract
      //              </a>
      //  <a dsf-grid-action="checkilst-view" class="grid-action">
      //  Checkilst View
      //  </a>
      //  <a dsf-grid-action="maintenance-view" class="grid-action">
      //  Maintenance View
      //  </a> `
    },
  ];
  ...
  static FixedAssetMaintenanceCellRenderer(params) {
    var action = `
    <a dsf-grid-action="edit" class="grid-action-icon fa fa-edit" title = "Edit"></a>
    <a dsf-grid-action="service" class="grid-action-icon fa fa-cogs" title ="Service History"> </a>
    <a dsf-grid-action="contract" class="grid-action-icon fa fa-file-text" title ="Contract Details"> </a>
    <a dsf-grid-action="checkilst-view" class="grid-action-icon fa fa-tasks" title ="Environment Condition Checkilst"></a>
    <a dsf-grid-action="vendor-details" class="grid-action-icon fa fa-book" title ="Vendor Contact Details"> </a>
    `;
    if (params.data.Performance == "Not Working") {
      return `${action}<a dsf-grid-action="fault-update" class="grid-action-icon fa fa-exclamation-circle" title ="Fault History"></a> `;
    } else {
      return action;
    }
  }
  ...
  static AssetDepreciationColumns = [
    ...
    // { headerName: "Expected Value After Useful Life", field: "" }, //ExpectedValueAfterUsefulLife
    {
      ...
      //  `<a dsf-grid-action="view" class="grid-action"> View </a>  `
    },
  ];

  static DepreciationActionRenderer(params) {
    var action = `<a dsf-grid-action="view-deprn" class="grid-action">
      View Depreciation
      </a>
    `;
    if (params.data.IsAssetScraped == false) {
      action = `${action}
                <a dsf-grid-action="scrap-asset" class="grid-action" style="background-color: #696969!important;">
                Scrap Asset
                </a>
              `;
    } else {
      action = `${action}
                <a dsf-grid-action="scrap-asset" class="grid-action" style="background-color: #FF8C00!important;">
                Undo Asset Scrap
                </a>
              `;
    }
  ...
  static FixedAssetCellRenderer(params) {
    ...
    if (
      ...
      template += ` <a dsf-grid-action="edit" class="grid-action-icon fixed-asset-action fa fa-edit" title="Edit"></a>`;
    if (
      GridColumnSettings.securityService.HasPermission(
        "fixed-asset-insurance-button"
      )
    )
      template += `<a dsf-grid-action="insurance-view" class="grid-action-icon fixed-asset-action fa fa-heartbeat" title="Insurance Details"></a>`;

    // var action: string = `
    //         <a dsf-grid-action="edit" class="grid-action-icon fa fa-edit" title="Edit"></a>
    //         <a dsf-grid-action="insurance-view" class="grid-action-icon fa fa-heartbeat" title="Insurance Details"></a>
    //         <a dsf-grid-action="print-barcode" class="grid-action-icon fa fa-barcode" title="Print Barcode"></a>
    //         `;
    ...
    if (
      ...
      // template = `
      // <a dsf-grid-action="remove-from-maintenance" class="fa fa-wrench" title="Remove from Maintenance Secition" aria-hidden="true" style="color: Black!important; font-size: 18px;"></a>
      // ` + template;
      // <a dsf-grid-action="remove-from-maintenance" class="grid-action" style="background-color:White!important;">
      // </a>
    } else {
      template =
        `
      <a dsf-grid-action="send-to-maintenance" class="fa fa-wrench" title="Send to Maintenance Secition" aria-hidden="true" style="color: #0773bc!important; font-size: 18px;"></a>
      ` + template;
    ...
    if (asset.IsAssetDamaged == true && asset.IsAssetDamageConfirmed == false) {
      template = ` ${template}
                <a dsf-grid-action="confirm-damage" class="grid-action-icon fa fa-check-circle" title="Confirm Damage" style="background-color: #42ba96 !important;"></a>
                <a dsf-grid-action="undo-damage" class="grid-action-icon fa fa-times" title="Undo Damage" style="background-color: #FF8C00!important;"></a>
             `;
    }
  ...
  `;
    if (["active", "partial"].includes(params.data.RequisitionStatus)) {
      template += ` <a dsf-grid-action="dispatch"
        class="grid-action">
         Dispatch
        </a>
  ...
  static ShowActionForGoodsReceiptList(params) {
    let template = `
        <a dsf-grid-action="view" title="View"
    ...
    if (params.data.canGRDispatch && params.data.ReceivedRemarks != null && params.data.IsQuantityAvailableToDispatchFromGR) {
      template += `<a dsf-grid-action="gr-dispatch" class="grid-action">GR Dispatch</a>`;
    }
    return template;
  }
  ...
  static VendorList = [
    ...
    { headerName: "Due Amount", field: "DueAmount", width: 150 },
    {
      ...
      field: "",
      width: 150,
      template: "<a dsf-grid-action='view' class='grid-action'> <i class='fa fa-credit-card'></i> Payment</a>"
    },
  ];
  static SupplierList = [
    { headerName: "GR Date", field: "GRDate", width: 150, cellRenderer: GridColumnSettings.PaymentDateRender },
  ...
  public static ManageShowOrHideChequeNo(params) {
    if (params.data.ShowChequeNumber == true) {
      let template = `
            <a dsf-grid-action="showorhideChequeNo" class="grid-action">Hide</a>
            `;
      return template;
    } else {
      let template = `
            <a dsf-grid-action="showorhideChequeNo" class="grid-action">Show</a>
            `;
      return template;
    }
  }
  public static ManageShowOrHidePayeeName(params) {
    if (params.data.ShowPayeeName == true) {
      let template = `
            <a dsf-grid-action="showorhidePayeeNameBasedOnStatus" class="grid-action">Hide</a>
            `;
      return template;
    } else {
      let template = `
            <a dsf-grid-action="showorhidePayeeNameBasedOnStatus" class="grid-action">Show</a>
            `;
      return template;
    }
  }
  ...
  public static OnlineApptPendingAction(param) {
    ...
    if (param.data.Status == "initiated") {
      template += "<a dsf-grid-action='checkin' class='grid-action'> <i class='fa-solid fa-circle-check'></i>Check In</a>";
    }
    return template;
  }
  ...
  static returnFromSubstore(params) {
    ...
    if (params.data.Status == "Pending") {
      let template = `
        <a dsf-grid-action="Receive" title="Receive Dispatched Items"
  ...
  static OPDPatientActionRenderer(params) {
    ...
    if (currPatient.IsFollowUp) {
      templateHtml +=
        '<a dsf-grid-action="removefollowup" class="fa fa-file-text" style="font-size:15px;position:relative;top:-5px; margin-right:10px;;" title="remove follow up""></a>';
    } else {
      templateHtml +=
        '<a dsf-grid-action="addfollowup" class="fa fa-file-text-o" style="font-size:15px;position:relative;top:-5px; margin-right:10px;" title="add follow up""></a>';
    }
  ...
  static OPFollowUpActionRenderer(params) {
    ...
    if (currPatient.IsFollowUp) {
      templateHtml +=
        '<a dsf-grid-action="removefollowup" class="fa fa-file-text" style="font-size:15px;position:relative;top:-5px" title="remove follow up""></a>';
    } else {
      templateHtml +=
        '<a dsf-grid-action="addfollowup" class="fa fa-file-text-o" style="font-size:15px;position:relative;top:-5px" title="add follow up""></a>';
    }
  ...
  public static ManageUserActionSubLedgerTemplate(params) {
    if (params.data.IsActive == true) {
      let template = `
            <a dsf-grid-action="activate/deactivate" class="grid-action">Deactivate</a>
            <a dsf-grid-action="edit" class="grid-action">Edit</a >
            `;
      return template;
    } else {
      let template = `
            <a dsf-grid-action="activate/deactivate" class="grid-action">Activate</a>
            `;
      return template;
    }
  }
  ...
  public static ActivateDeactivateTemplate(params) {
    ...
    if (params.data.IsActive == true) {
      ...
      template = `<a dsf-grid-action="activate-deactivate" class="grid-action">
              Deactivate
            </a>
          <a dsf-grid-action="edit" class="grid-action">Edit</a >`;
    } else {
  ...
  static ViewMedicarePatientList(params) {
    let template;
    template = `
        <a dsf-grid-action="medicarePatient" class="grid-action">View/Edit</a>`;
    return template;
  }
  ...
  static InsurancePendingClaimGridSettings = [
    ...
    { headerName: "Claimable Amount", field: "ClaimableAmount", width: 100 },
    {
      ...
      width: 120,
      template: `<a dsf-grid-action="claim-review" class="grid-action">
  ...
  static ClaimPreview(params) {
    return `<a dsf-grid-action="claim-preview">
  ...
  static GetInsurancePendingClaimActions() {
    let template = "";
    template += ` <a dsf-grid-action="approve-reject-amount" class="grid-action">Approve/Reject Amount</a>
          <a dsf-grid-action="new-payment" class="grid-action"><i class="fa fa-plus"></i>Payments</a>
          <a dsf-grid-action="view-payments" class="grid-action">View</a>`;
    return template;
  }
  ...
  static DischargeStatementColumnList = [
...

    {
      headerName: "Action",
      field: "",
      template: `<a dsf-grid-action="show-statement-details" class="grid-action">
                Show Details
             </a>
             `
      //    <a dsf-grid-action="show-statement-summary" class="grid-action">
      //    Show Summary
      // </a>
    },
  ];
  ...
  public SchemeRefundGridCols = [
    ...
    { headerName: "Remarks", field: "Remarks", width: 120 },
    {
      ...
      field: "",
      width: 250,
      template: `<a dsf-grid-action="Print" class="grid-action-edit" >
      Print
      </a>`
    }
  ];
  ...
  static InvoiceEnteredCellRenderer(params) {
    ...
    if (params.data.ReferralCount > 0) {
      ...
      template = `<a dsf-grid-action="Yes" class="grid-action">
              Yes(${params.data.ReferralCount})</a>`;
    } else {
      template = `<a dsf-grid-action="No" class="grid-action">
  ...
  public static ActivateDeactivateReferringOrganizationTemplate(params) {
    let template;
    if (params.data.IsActive) {
      template = `<a dsf-grid-action="activateOrganization" class="grid-action">
    Deactivate
  </a>
<a dsf-grid-action="edit" class="grid-action">Edit</a >`;
    } else {
      template = `<a dsf-grid-action="DeactivateOrganization" class="grid-action">
      Activate
     </a>`;
    }
    return template;
  ...
  static CreatedOnTime(params) {
    ...
    static ConsultationRequestActionTemplate(params) {
        ...
        if (params.data.Status.toLowerCase() === ENUM_ConsultationRequestStatus.Requested.toLowerCase()
            ...
            template += `<a dsf-grid-action="respond" class="grid-action">
      Respond
      </a>`;
        }
