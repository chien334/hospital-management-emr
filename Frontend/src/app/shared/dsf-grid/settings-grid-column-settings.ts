...
export class SettingsGridColumnSettings {
  ...
  BillingPackageAction(params) {
    if (params.data.IsActive == true) {
      let template =
        `<a dsf-grid-action="edit" class="grid-action-edit" >
      Edit
      </a>
      <a dsf-grid-action="activateDeactivateBasedOnStatus" class="grid-action-disable">
              Deactivate
      </a>`
      return template;
    }
      ...
      let template =
        `<a dsf-grid-action="activateDeactivateBasedOnStatus" class="grid-action blinking-btn-secondary"  style="background-color: #afb8af;color: black;">
              Activate
      </a>`
      return template;
    }
  ...
  //             <a dsf-grid-action="showHistory" class="grid-action">
  //              Price History
  //           </a>
  //              <a dsf-grid-action="activateDeactivateBillItem" class="grid-action"  style="background-color: orange;color: black;">
  //            Deactivate
  //          </a>`
  //    return template
  //  }
  ...
  //              Price History
  //           </a>
  //              <a dsf-grid-action="activateDeactivateBillItem" class="grid-action"  style="background-color: #afb8af;color: black;">
  //              Activate
  //             </a>`
  //    return template;
  //  }
  ...
  public BillingItemListActionTemplateWithPermission(params) {
    if (params.data.IsActive == false) {
      ...
      if (SettingsGridColumnSettings.securityServ.HasPermission("btn-settings-bill-item-pricehistory")) {
        template += `<a dsf-grid-action="showHistory" class="grid-action">
               Price History
            </a>`
      }

      if (SettingsGridColumnSettings.securityServ.HasPermission("btn-settings-bill-item-activate")) {
        template += `<a dsf-grid-action="activateDeactivateBillItem" class="grid-action"  style="background-color: #afb8af;color: black;">
              Activate
             </a>`
      }
      return template;
      ...
      if (SettingsGridColumnSettings.securityServ.HasPermission("btn-settings-bill-item-activate")) {
        template += `<a dsf-grid-action="activateDeactivateBillItem" class="grid-action"  style="background-color: orange;color: black;">
             Deactivate
           </a>`
      }
      return template;
  ...
  public BillingServiceItemListActionTemplate(params) {
    if (params.data.IsActive == false) {
      ...
      if (SettingsGridColumnSettings.securityServ.HasPermission("btn-settings-bill-item-activate")) {
        template += `<a dsf-grid-action="activateDeactivateServiceItem" class="grid-action"  style="background-color: #afb8af;color: black;">
              Activate
             </a>`
      }
      return template;
      ...
      if (SettingsGridColumnSettings.securityServ.HasPermission("btn-settings-bill-item-activate")) {
        template += `<a dsf-grid-action="activateDeactivateServiceItem" class="grid-action"  style="background-color: orange;color: black;">
             Disable
           </a>`
      }
      return template;
  ...
  public ServiceDepartmentListAction(params) {
    if (params.data.IsActive == false) {
      ...
      if (SettingsGridColumnSettings.securityServ.HasPermission("btn-settings-serv-dept-activate")) {
        template += `<a dsf-grid-action="activateDeactivateServiceDept" class="grid-action"  style="background-color: #afb8af;color: black;">
              Activate
             </a>`
      }
      return template;
      ...
      if (SettingsGridColumnSettings.securityServ.HasPermission("btn-settings-serv-dept-activate")) {
        template += `<a dsf-grid-action="activateDeactivateServiceDept" class="grid-action"  style="background-color: orange;color: black;">
             Deactivate
           </a>`
      }
      return template;
  ...
  public ReportingItemListActionTemplateWithPermission(params) {
    if (params.data.IsActive == false) {
      ...
      if (SettingsGridColumnSettings.securityServ.HasPermission("btn-settings-reporting-items-activate")) {
        template += `<a dsf-grid-action="activateDeactivate" class="grid-action"  style="background-color: #afb8af;color: black;">
              Activate
             </a>`
      }
      return template;
      ...
      if (SettingsGridColumnSettings.securityServ.HasPermission("btn-settings-reporting-items-manageItem")) {
        template += `<a dsf-grid-action="manageReportingItem" class="grid-action">
               Manage Services
            </a>`
      }

      if (SettingsGridColumnSettings.securityServ.HasPermission("btn-settings-reporting-items-activate")) {
        template += `<a dsf-grid-action="activateDeactivate" class="grid-action"  style="background-color: orange;color: black;">
             Deactivate
           </a>`
      }
      return template;
  ...
  public AdditionalServiceItemGridActions(params) {
    if (params.data.IsActive) {
      ...
      if (
        ...
        template += `<a dsf-grid-action="activateDeactivate" class="grid-action">
          Deactivate
        </a>`;
      }
      ...
      if (
        ...
        return (template += `<a dsf-grid-action="activateDeactivate" class="grid-action">
          Activate
        </a>`);
      }
    }
    ...
    { headerName: "DefaultRouteName", field: "DefaultRouteName", width: 100 },
    {
      ...
      template:
        `<a dsf-grid-action="edit" class="grid-action">
            ...
            <a dsf-grid-action="managePermission" class="grid-action">
               ManagePermission
             </a>`
    }
  ]
  public UserList = [
    ...
    { headerName: "Email", field: "Email", width: 120, cellStyle: this.UserGridCellStyle },
    {
      ...
      //    Edit
      // </a>
      //<a dsf-grid-action="resetPassword" class="grid-action">
      //    ResetPassword
      // </a>
      //<a dsf-grid-action="manageRole" class="grid-action">
      //   MangeRole
      // </a>`
    }
  ]
  ...
  public MunicipalityActionButtonRenderer(params) {
    ...
    if (params.data.IsActive) {
      template += `<a dsf-grid-action="disable" class="grid-action bg-red red">
                Disable
             </a>`;
    }
    else {
      template += `<a dsf-grid-action="enable" class="grid-action">
                Enable
             </a>`;
    }
    return template;
      ...
      let template =
        `
            ...
            <a dsf-grid-action="manageRole" class="grid-action">
             ...
             <a dsf-grid-action="activateDeactivateUser" class="grid-action">
              Deactivate
            </a>`
      return template
    }
  ...
  public StoreSettingAction(params) {
    ...
    if (params.data.ParentStoreId == 0) {
      ...
      let template =
        ...
        <a dsf-grid-action="activateDeactivateStore" class="grid-action">
                Deactivate
        </a>`
      return template;
    }
  ...
  public PrinterSettingActionTemplate(params) {
    if (params.data.IsActive == true) {
      let template =
        ...
        <a dsf-grid-action="deactivatePrinterSetting" class="grid-action blinking-btn-warning" style="background-color: orange;color: black;">
                Deactivate
        </a>`
      return template;
    }
      ...
      let template =
        `<a dsf-grid-action="activatePrinterSetting" class="grid-action blinking-btn-secondary"  style="background-color: #afb8af;color: black;">
                Activate
        </a>`
      return template;
    }
  ...
  public pricecategoryRenderer(params) {
    if (params.data.IsActive == true) {
      let template =
        ...
        <a dsf-grid-action="deactivatePriceCategorySetting" class="grid-action-disable">
                Disable
        </a>`
      return template;
    }
      ...
      let template =
        `<a dsf-grid-action="activatePriceCategorySetting" class="grid-action blinking-btn-secondary"  style="background-color: #afb8af;color: black;">
                Activate
        </a>`
      return template;
    }
  ...
  public billSchemeRenderer(params) {
    if (params.data.IsActive == true) {
      let template =
        ...
        <a dsf-grid-action="ItemSettings" class="grid-action">
        Item Settings
        </a>
        <a dsf-grid-action="deactivateBillSchemeSetting" class="grid-action-disable">
                Deactivate
        </a>`
      return template;
    }
      ...
      let template =
        `<a dsf-grid-action="activateBillSchemeSetting" class="grid-action blinking-btn-secondary"  style="background-color: #afb8af;color: black;">
                Activate
        </a>`
      return template;
    }
  ...
  public SchemeVsPriceCategoryItemListActionTemplateWithPermission(params) {
    if (params.data.IsActive === false) {
      ...
      if (SettingsGridColumnSettings.securityServ.HasPermission("btn-settings-scheme-pricecategory-activate")) {
        template += `<a dsf-grid-action="activateDeactivateSchemeVsPriceCategoryItem" class="grid-action"  style="background-color: #afb8af;color: black;">
              Activate
             </a>`
      }
      return template;
      ...
      if (SettingsGridColumnSettings.securityServ.HasPermission("btn-settings-scheme-pricecategory-activate")) {
        template += `<a dsf-grid-action="activateDeactivateSchemeVsPriceCategoryItem" class="grid-action"  style="background-color: orange;color: black;">
             Deactivate
           </a>`
      }
      return template;
  ...
  public BedFeatureSchemePriceCategoryMapActionRenderer(params) {
    ...
    if (params.data.IsActive == true) {
      ...
      <a dsf-grid-action="deactivateBedFeatureSchemePriceCategoryMap" class="grid-action-disable">
              Deactivate
      </a>`
      return template;
    }
      ...
      let template =
        `<a dsf-grid-action="activateBedFeatureSchemePriceCategoryMap" class="grid-action blinking-btn-secondary"  style="background-color: #afb8af;color: black;">
              Activate
      </a>`
      return template;
    }
  ...
  public MinimumDepositSettingsActionRenderer(params) {
    ...
    if (params.data.IsActive == true) {
      ...
      <a dsf-grid-action="deactivateSettingDeposit" class="grid-action-disable">
              Deactivate
      </a>`
      return template;
    }
      ...
      let template =
        `<a dsf-grid-action="activateSettingDeposit" class="grid-action blinking-btn-secondary"  style="background-color: #afb8af;color: black;">
              Activate
      </a>`
      return template;
    }
  ...
  public ManageTemplateSettingAction(params) {
    if (params.data.IsActive == true) {
      let template =
        `<a dsf-grid-action="field-mapping" class="grid-action" >
        Field Mapping
        </a>
        <a dsf-grid-action="edit" class="grid-action" >
        Edit
        </a>
        <a dsf-grid-action="activate-deactivate" class="grid-action" >
        Deactivate
        </a>`
      return template;
    }
