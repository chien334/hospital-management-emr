...
using DsfEMR.ServerModel.HelpdeskModels;
using System.Data;
...
namespace DsfEMR.Controllers.HelpDesk
{
        ...
        public string Get(string reqType, string status)
        {
            ...
            /*if (reqType == "getBedPatientInfo")
               ...
               *//* else if (reqType == "getWardinfo")
                ...
                if (reqType == "get-bedoccupancy-of-wards")
                {
                    DsfHTTPResponse<DataTable> data = new DsfHTTPResponse<DataTable>();
                    try
                    {
                    ...
                    return DsfJSONConvert.SerializeObject(data);
                }
