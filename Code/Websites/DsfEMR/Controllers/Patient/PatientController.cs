...
using DsfEMR.Services.Appointment.DTO;
...
namespace DsfEMR.Controllers
{
    public class PatientController : CommonController
    {
        ...
        public string PatientById(int patientId)
        {
            ...
            return DsfJSONConvert.SerializeObject(_objResponseData, true);
        }
        ...
        public object PatientByCode(string patientCode)
        {
            ...
            {
                _objResponseData.Status = ENUM_Dsf_HTTP_ResponseStatus.Failed;
        ...
        //        //    var reportDetails = Request.Form["reportDetails"];
        //        //    RbacUser currentUser = HttpContext.Session.Get<RbacUser>("currentuser");
        //        //    PatientFilesModel patFileData = DsfJSONConvert.DeserializeObject<PatientFilesModel>(reportDetails);
        ...
        //        //    ///Read patient Files Model Other Data
        //        //    string fileInfoStr = this.ReadPostData();
        //        //    PatientFilesModel patFileData = DsfJSONConvert.DeserializeObject<PatientFilesModel>(fileInfoStr);
        ...
        //        //{
        //        //    string str = this.ReadPostData();
        //        //    HealthCardInfoModel healthCard = DsfJSONConvert.DeserializeObject<HealthCardInfoModel>(str);
        ...
        //        //    RbacUser currentUser = HttpContext.Session.Get<RbacUser>("currentuser");
        //        //    string str = this.ReadPostData();
        //        //    NeighbourhoodCardModel neighbourCard = DsfJSONConvert.DeserializeObject<NeighbourhoodCardModel>(str);
        ...
        //        //    PatientModel govInsNewPatient = DsfEMR.Controllers.PatientBL.GetPatientModelFromPatientVM(govInsClientPatObj, connString, patDbContext);
        //        //    InsuranceModel patInsInfo = DsfEMR.Controllers.PatientBL.GetInsuranceModelFromInsPatientVM(govInsClientPatObj, currentUser.EmployeeId);
        ...
        //        //    PatientModel newPatient = DsfEMR.Controllers.PatientBL.GetPatientModelFromPatientVM(billingOutPatVM, connString, patDbContext);
        ...
        {
            _patientDbContext = this.AddAuditField(_patientDbContext);
            HealthCardInfoModel healthCard = DsfJSONConvert.DeserializeObject<HealthCardInfoModel>(stringContent);
            healthCard.CreatedOn = System.DateTime.Now;
        ...
        private object SaveGovInsurancePatient(string postStringContent, RbacUser currentUser)
        {
            ...
            PatientModel govInsNewPatient = DsfEMR.Controllers.PatientBL.GetPatientModelFromPatientVM(govInsClientPatObj, connString, _patientDbContext);
            InsuranceModel patInsInfo = DsfEMR.Controllers.PatientBL.GetInsuranceModelFromInsPatientVM(govInsClientPatObj, currentUser.EmployeeId);
        ...
        private object SaveBillingOutPatient(string postStringContent, RbacUser currentSessionUser)
        {
            ...
            PatientModel newPatient = DsfEMR.Controllers.PatientBL.GetPatientModelFromPatientVM(billingOutPatVM, connString, _patientDbContext);
            newPatient.CreatedBy = currentSessionUser.EmployeeId;
            newPatient.CreatedOn = DateTime.Now;
