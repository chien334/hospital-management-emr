...
using DsfEMR.ServerModel.Helpers;//for appointmenthelpers
...
using DsfEMR.ServerModel.AdmissionModels.Config;
...
using DsfEMR.Services.ADTSettings.DTO;
...
namespace DsfEMR.Controllers
{
    ...
    public class ADTSettingsController : CommonController
    {
        ...
        {
            BedModel bed = DsfJSONConvert.DeserializeObject<BedModel>(ipDataStr);
        ...
        {
            BedFeaturesMap bedFeaturesMap = DsfJSONConvert.DeserializeObject<BedFeaturesMap>(ipDataStr);
        ...
        private object AddWard(string ipDataStr, RbacUser currentUser)
        {
            ...
            WardModel ward = DsfJSONConvert.DeserializeObject<WardModel>(ipDataStr);
        ...
        {
            ParameterModel parameter = DsfJSONConvert.DeserializeObject<ParameterModel>(ipDataStr);
        ...
        private object AddAdtBedFeatureSchemePriceCategory(List<AdtBedFeatureSchemePriceCategory_DTO> adtBedFeatureSchemePriceCategory_dto, RbacUser currentUser)
        {
            using (var dbContextTransaction = _admissionDbContext.Database.BeginTransaction())
            {
                try
                {
                    List<AdtBedFeatureSchemePriceCategoryMapModel> bedFeatureSchemePriceCategory = DsfJSONConvert.DeserializeObject<List<AdtBedFeatureSchemePriceCategoryMapModel>>(DsfJSONConvert.SerializeObject(adtBedFeatureSchemePriceCategory_dto));
        ...
        private object SaveBedFeature(Settings.DTO.BedFeature_DTO bedFeatureDTO, RbacUser currentUser)
        {
            using (var dbContextTransaction = _admissionDbContext.Database.BeginTransaction())
            {
                try
                {
                    /*BedFeature bedFeature = DsfJSONConvert.DeserializeObject<BedFeature>(ipDataStr);*/
        ...
        {
            //List<BedFeaturesMap> bedFeaturesMap = DsfJSONConvert.DeserializeObject<List<BedFeaturesMap>>(str);
            BedFeaturesMap bedFeaturesMap = DsfJSONConvert.DeserializeObject<BedFeaturesMap>(ipDataStr);
