...
namespace DsfEMR.Controllers.Billing
{
    public class BillingBL
    {
        ...
        {
            DateTime currCounterDay = (DateTime)DsfCache.Get("currCounterDay");
            if (currCounterDay == null)
            {
                DsfEMR.DalLayer.BillingDbContext billingDbcontext = new DalLayer.BillingDbContext(connString);
        ...
        //    DsfEMR.DalLayer.BillingDbContext billDbContext = new DalLayer.BillingDbContext(connString);
        ...
        //this function post IRD posting log details to Dsf IRD_Log table
        ...
        public static void SyncToSSFServer(SSF_ClaimBookingService_DTO claimBooking, string moduleName, SSFDbContext dbContext, PatientSchemeMapModel patientSchemeMap, RbacUser currentUser)
        {
            ...
            try
            {
                ...
                realTimeclaimBookingService = DsfEMR.Sync.SSF.APIs.BookClaim(claimBooking, SSFCred);
            }
            catch (Exception ex)
            {
        ...
        public static string GetCoreParameterValueByKeyName_String(SSFDbContext ssfDbContext, string paramGroup, string paramName, string keyNameOfJsonObj)
        {
            ...
            if (param != null)
            {
                ...
                var data = DsfJSONConvert.DeserializeObject<JObject>(paramValueStr);
                if (data != null)
                {
