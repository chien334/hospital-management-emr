    ...
    public class PayrollController : CommonController
    {
        ...
        public string Post()
        {
            ...
            try
            {
                ...
                {
                    List<AttendanceDailyTimeRecord> attendanceDailyTimeRecords = DsfJSONConvert.DeserializeObject<List<AttendanceDailyTimeRecord>>(str);
                ...
                {
                    List<DailyMuster> dailyMusters = DsfJSONConvert.DeserializeObject<List<DailyMuster>>(str);
                ...
                {
                    List<WeekendHolidays> weekendHolidaysList = DsfJSONConvert.DeserializeObject<List<WeekendHolidays>>(str);
                ...
                {
                    HolidayModel holidayModel = DsfJSONConvert.DeserializeObject<HolidayModel>(str);
                ...
                {
                    LeaveRuleModel leaveRuleModel = DsfJSONConvert.DeserializeObject<LeaveRuleModel>(str);
                ...
                {
                    LeaveCategory leave = DsfJSONConvert.DeserializeObject<LeaveCategory>(str);
                ...
                else if(reqType == "post-emp-leave-requests")
                {
                    ...
                    List<EmployeeLeaveModel>  leaveList = DsfJSONConvert.DeserializeObject<List<EmployeeLeaveModel>>(str);
        ...
        public string Put()
        {
            ...
            try
            {
                ...
                {
                    DailyMuster dailyMuster = DsfJSONConvert.DeserializeObject<DailyMuster>(str);
