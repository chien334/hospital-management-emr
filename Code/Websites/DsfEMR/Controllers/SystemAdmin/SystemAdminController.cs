...
using DsfEMR.ServerModel.SystemAdminModels;
...
namespace DsfEMR.Controllers
{
    public class SystemAdminController : CommonController
    {
        ...
        //{
        //    DsfHTTPResponse<List<object>> responseData = new DsfHTTPResponse<List<object>>();
        //    DsfHTTPResponse<object> responseDataObj = new DsfHTTPResponse<object>();
        ...
        //}
        //    #region DsfAuditTrail Details 
        //else
        //if (reqtype == "get-audit-trail-details")
        //{
        //    reportingdbcontext dbcontext = new reportingdbcontext(this.connstringadmin);
        //    //dsfhttpresponse<datatable> resdata = new dsfhttpresponse<datatable>();
        ...
        //    return dsfjsonconvert.serializeobject(responsedataobj, true);
        //}
        ...
        //    DsfHTTPResponse<List<InvoiceDetailsModel>> resData = new DsfHTTPResponse<List<InvoiceDetailsModel>>();
        //    resData.Results = res;
        //    resData.Status = "OK";
        //    return DsfJSONConvert.SerializeObject(resData, true);
        //}
        //else 
        ...
        //    DsfHTTPResponse<List<PhrmInvoiceDetails>> resData = new DsfHTTPResponse<List<PhrmInvoiceDetails>>();
        //    resData.Results = res;
        //    resData.Status = "OK";
        //    return DsfJSONConvert.SerializeObject(resData, true);
        //}
        ...
        //    ReportingDbContext dbContext = new ReportingDbContext(this.connStringAdmin);
        //    DsfHTTPResponse<List<SqlAuditModel>> resData = new DsfHTTPResponse<List<SqlAuditModel>>();
        ...
        private object PostRestoreDatabase( string ipDataStr)
        {
                ...
                DatabaseLogModel dbBackupLogDataFromClient = DsfJSONConvert.DeserializeObject<DatabaseLogModel>(ipDataStr);
        ...
        //        #region Database Backup functionality
                ...
                //    DatabaseLogModel dbBackupLogDataFromClient = DsfJSONConvert.DeserializeObject<DatabaseLogModel>(dataString);
                //    string backupDBFilePath = dbBackupLogDataFromClient.FolderPath + dbBackupLogDataFromClient.FileName;
                //    string backupDBFileVersion = dbBackupLogDataFromClient.DatabaseVersion;
                //    //Transaction Begin
                //    using (var dbContextTransaction = systemAdmindbContext.Database.BeginTransaction())
        ...
        private Boolean BackupDatabase(string connStringAdmin)
        {
            try
            {
                ...
                if (isPg)
                {
                    ...
                    string filename = "dsf_emr_backup_" + DateTime.Now.ToString("yyyy_MM_dd_HHmmss") + ".bak";
                    string fullPath = Path.Combine(folderPath, filename);
                    System.IO.File.WriteAllText(fullPath, "-- Dsf EMR PostgreSQL Mock Backup");
        ...
        private Boolean RestoreDatabase(string connStringAdmin, DatabaseLogModel dbBackupLogDataFromClient)
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        conAdmin.Open();
                        using (SqlConnection conDsfEMRLive = new SqlConnection(connString))
                        {
                            ...
                            SqlCommand sqlCmdSingleUserMode = new SqlCommand(sqlSetSingleUserModeQuery, conDsfEMRLive);
                            ...
                            SqlCommand sqlCmdRestoreDB = new SqlCommand(sqlRestoreDBQuery, conDsfEMRLive);
                            ...
                            SqlCommand sqlCmdMultiUserMode = new SqlCommand(sqlSetMultiUserModeQuery, conDsfEMRLive);
