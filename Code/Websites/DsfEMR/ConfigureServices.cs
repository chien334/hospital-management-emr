        ...
        public static IServiceCollection AddSwaggerAndJwtServices(this IServiceCollection services, IConfigurationRoot Configuration)
        {
            ...
            services.AddSwaggerGen(config =>
            {
                config.SwaggerDoc("v1", new Microsoft.OpenApi.Models.OpenApiInfo
                {
                    ...
                    {
                        Name = "DsfEMR",
                        Email = "info.dsf-emr.com",
                        Url = new Uri("https://dsfhealth.com/")
                    },
                    Description = "We are testing Swagger in DsfEMR",
                    TermsOfService = new Uri("https://dsfhealth.com/")
                });
                ...
                //DsfEmrAPI.xml file is created by the Project>build event
                //and it is read by swagger to show in the api documentation.
                //We can show: <summary>, <remarks>, <response>
                var filePath = Path.Combine(System.AppContext.BaseDirectory, "DsfEmrAPI.xml");
