...
namespace DsfEMR.Controllers
{
    public class PharmacyReportController : CommonController
    {
        ...
        {
            DsfHTTPResponse<List<PHRMItemWiseStockReportModel>> responseData = new DsfHTTPResponse<List<PHRMItemWiseStockReportModel>>();
            try
            {
        ...
        {
            DsfHTTPResponse<dynamic> responseData = new DsfHTTPResponse<dynamic>();
            try
            {
                PharmacyReportingDbContext phrmreportingDbContext = new PharmacyReportingDbContext(connString);
        ...
        public FileContentResult ExportToExcelPHRMRackStockDistributionReport(string RackIds, int LocationId)
        {
            try
            {
                ...
                var SummaryData = DsfJSONConvert.SerializeObject(spResult.Tables[1].Rows[0].Table);
