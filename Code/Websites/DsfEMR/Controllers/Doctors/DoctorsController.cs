...
namespace DsfEMR.Controllers
{
    ...
    public class DoctorsController : CommonController
    {
        ...
        //if (reqType == "concludeVisit")
        //{
        //    var visitid = DsfJSONConvert.DeserializeObject<int>(str);
        ...
        //if (reqType == "reassignProvider")
        //{
        //    VisitModel visitData = DsfJSONConvert.DeserializeObject<VisitModel>(str);
        ...
        //if (reqType == "changeProvider")
        //{
        //    VisitModel data = DsfJSONConvert.DeserializeObject<VisitModel>(str);
        ...
        private object PostConcludeVisit(string ipDataStr)
        {
            ...
            var visitid = DsfJSONConvert.DeserializeObject<int>(ipDataStr);
        ...
        private object PutReassignProvider(string ipDataStr)
        {
            ...
            VisitModel visitData = DsfJSONConvert.DeserializeObject<VisitModel>(ipDataStr);
            visitData.ModifiedOn = System.DateTime.Now;
            visitData.PerformerName = GetProviderName(visitData.PerformerId);
        ...
        private object UpdateProvider(string ipDataStr)
        {
            ...
            VisitModel data = DsfJSONConvert.DeserializeObject<VisitModel>(ipDataStr);
